...
namespace Fraktalia.VoxelGen
{
	...
	public class VoxelGeneratorSettings : EditorWindow
	{
		...
		void OnGUI()
		{
			...
			CopyKey = (KeyCode)EditorGUILayout.EnumPopup("Editor Copy Key:", CopyKey);
			...
			if (GUI.changed)
			{
				...
				EditorPrefs.SetInt("FraktaliaVoxelGenerator_CopyKey", (int)CopyKey);
			...
			if (GUILayout.Button("Clear Preferences"))
			{
				...
				EditorPrefs.DeleteKey("FraktaliaVoxelGenerator_CopyKey");
		...
		internal static void InitializeSettings()
		{
			...
			VoxelGeneratorSettings.CopyKey = LoadKey("FraktaliaVoxelGenerator_CopyKey", KeyCode.C);
			VoxelGeneratorSettings.ApplyKey = LoadKey("FraktaliaVoxelGenerator_SpotPaintingMode", KeyCode.V);
			VoxelGeneratorSettings.UndoKey = LoadKey("FraktaliaVoxelGenerator_UndoKey", KeyCode.Z);
			VoxelGeneratorSettings.RedoKey = LoadKey("FraktaliaVoxelGenerator_RedoKey", KeyCode.Y);
