...
namespace Fraktalia.Core.Mathematics.Geometry
{
    ...
    internal struct FPlane
    {
        ...
        /// </remarks>
        public Ffloat4 NormalAndDistance;
        ...
        public FPlane(float coefficientA, float coefficientB, float coefficientC, float coefficientD)
        {
            NormalAndDistance = Normalize(new Ffloat4(coefficientA, coefficientB, coefficientC, coefficientD));
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public FPlane(Ffloat3 normal, float distance)
        {
            NormalAndDistance = Normalize(new Ffloat4(normal, distance));
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public FPlane(Ffloat3 normal, Ffloat3 pointInPlane)
        : this(normal, -Fmath.dot(normal, pointInPlane))
        {
        }
        ...
        /// <param name="pointInPlane">A point that lies in the plane.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public FPlane(Ffloat3 vector1InPlane, Ffloat3 vector2InPlane, Ffloat3 pointInPlane)
        : this(Fmath.cross(vector1InPlane, vector2InPlane), pointInPlane)
        {
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FPlane CreateFromUnitNormalAndDistance(Ffloat3 unitNormal, float distance)
        {
            return new FPlane { NormalAndDistance = new Ffloat4(unitNormal, distance) };
        }
        ...
        /// <returns>Normalized Plane constructed from given inputs.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FPlane CreateFromUnitNormalAndPointInPlane(Ffloat3 unitNormal, Ffloat3 pointInPlane)
        {
            return new FPlane { NormalAndDistance = new Ffloat4(unitNormal, -Fmath.dot(unitNormal, pointInPlane)) };
        }
        ...
        /// (A, B, C) is not unit length, then you must normalize the plane by calling <see cref="Normalize(FPlane)"/>.
        /// </remarks>
        public Ffloat3 Normal
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FPlane Normalize(FPlane plane)
        {
            return new FPlane { NormalAndDistance = Normalize(plane.NormalAndDistance) };
        }
        ...
        /// </summary>
        /// <remarks>
        /// The plane coefficients are A, B, C, D and stored in that order in the <see cref="Ffloat4"/>.
        /// </remarks>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 Normalize(Ffloat4 planeCoefficients)
        {
            float recipLength = Fmath.rsqrt(Fmath.lengthsq(planeCoefficients.xyz));
            return new FPlane { NormalAndDistance = planeCoefficients * recipLength };
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public float SignedDistanceToPoint(Ffloat3 point)
        {
            CheckPlaneIsNormalized();
            return Fmath.dot(NormalAndDistance, new Ffloat4(point, 1.0f));
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Ffloat3 Projection(Ffloat3 point)
        {
            CheckPlaneIsNormalized();
        ...
        /// </summary>
        public FPlane Flipped => new FPlane { NormalAndDistance = -NormalAndDistance };

        /// <summary>
        /// Implicitly converts a <see cref="FPlane"/> to <see cref="Ffloat4"/>.
        /// </summary>
        /// <param name="plane">Plane to convert.</param>
        /// <returns>A <see cref="Ffloat4"/> representing the plane.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Ffloat4(FPlane plane) => plane.NormalAndDistance;

        [Conditional("ENABLE_UNITY_COLLECTIONS_CHECKS")]
        void CheckPlaneIsNormalized()
        {
            float ll = Fmath.lengthsq(Normal.xyz);
