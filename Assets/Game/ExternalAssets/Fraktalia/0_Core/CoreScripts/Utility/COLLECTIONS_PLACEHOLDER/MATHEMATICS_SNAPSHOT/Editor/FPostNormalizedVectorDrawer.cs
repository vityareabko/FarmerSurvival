...
{
    [CustomPropertyDrawer(typeof(FPostNormalizeAttribute))]
    class FPostNormalizedVectorDrawer : FPrimitiveVectorDrawer
    {
        ...
        class VectorPropertyGUIData
        {
            ...
            readonly Dictionary<SerializedProperty, Fdouble4> m_PostNormalizedValues = new Dictionary<SerializedProperty, Fdouble4>();
            ...
            void UpdatePostNormalizedValues()
            {
                ...
                {
                    var postNormalizedValue = new Fdouble4();
            ...
            public void PostNormalize(Func<Fdouble4, Fdouble4> normalize)
            {
                m_VectorProperty.serializedObject.ApplyModifiedProperties();
                foreach (var target in m_PostNormalizedValues)
                {
        ...
        protected virtual Fdouble4 Normalize(Fdouble4 value)
        {
            return Fmath.normalizesafe(value);
        }
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (!guiData.Valid)
            {
                EditorGUI.HelpBox(
                    ...
                    L10n.Tr($"{typeof(FPostNormalizeAttribute).Name} only works with decimal vector types."),
                    MessageType.None
                );
                return;
            }
