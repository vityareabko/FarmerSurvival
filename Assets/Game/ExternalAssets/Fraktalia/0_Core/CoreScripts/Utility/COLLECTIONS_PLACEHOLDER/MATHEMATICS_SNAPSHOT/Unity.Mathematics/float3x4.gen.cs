...
namespace Fraktalia.Core.Mathematics
{
    ...
    public partial struct Ffloat3x4 : System.IEquatable<Ffloat3x4>, IFormattable
    {
        ...
        public static readonly Ffloat3x4 zero;
        ...
        public Ffloat3x4(Ffloat3 c0, Ffloat3 c1, Ffloat3 c2, Ffloat3 c3)
        {
            this.c0 = c0;
            this.c1 = c1;
            this.c2 = c2;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Ffloat3x4(float m00, float m01, float m02, float m03,
                        float m10, float m11, float m12, float m13,
                        float m20, float m21, float m22, float m23)
        {
            this.c0 = new Ffloat3(m00, m10, m20);
            this.c1 = new Ffloat3(m01, m11, m21);
            this.c2 = new Ffloat3(m02, m12, m22);
            this.c3 = new Ffloat3(m03, m13, m23);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Ffloat3x4(bool v)
        {
            this.c0 = Fmath.select(new Ffloat3(0.0f), new Ffloat3(1.0f), v);
            this.c1 = Fmath.select(new Ffloat3(0.0f), new Ffloat3(1.0f), v);
            this.c2 = Fmath.select(new Ffloat3(0.0f), new Ffloat3(1.0f), v);
            this.c3 = Fmath.select(new Ffloat3(0.0f), new Ffloat3(1.0f), v);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Ffloat3x4(Fbool3x4 v)
        {
            this.c0 = Fmath.select(new Ffloat3(0.0f), new Ffloat3(1.0f), v.c0);
            this.c1 = Fmath.select(new Ffloat3(0.0f), new Ffloat3(1.0f), v.c1);
            this.c2 = Fmath.select(new Ffloat3(0.0f), new Ffloat3(1.0f), v.c2);
            this.c3 = Fmath.select(new Ffloat3(0.0f), new Ffloat3(1.0f), v.c3);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Ffloat3x4(Fdouble3x4 v)
        {
            this.c0 = (Ffloat3)v.c0;
            this.c1 = (Ffloat3)v.c1;
            this.c2 = (Ffloat3)v.c2;
            this.c3 = (Ffloat3)v.c3;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Ffloat3x4(float v) { return new Ffloat3x4(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Ffloat3x4(bool v) { return new Ffloat3x4(v); }

        /// <summary>Explicitly converts a bool3x4 matrix to a float3x4 matrix by componentwise conversion.</summary>
        /// <param name="v">bool3x4 to convert to float3x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Ffloat3x4(Fbool3x4 v) { return new Ffloat3x4(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Ffloat3x4(int v) { return new Ffloat3x4(v); }

        /// <summary>Implicitly converts a int3x4 matrix to a float3x4 matrix by componentwise conversion.</summary>
        /// <param name="v">int3x4 to convert to float3x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Ffloat3x4(Fint3x4 v) { return new Ffloat3x4(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Ffloat3x4(uint v) { return new Ffloat3x4(v); }

        /// <summary>Implicitly converts a uint3x4 matrix to a float3x4 matrix by componentwise conversion.</summary>
        /// <param name="v">uint3x4 to convert to float3x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Ffloat3x4(Fuint3x4 v) { return new Ffloat3x4(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Ffloat3x4(double v) { return new Ffloat3x4(v); }

        /// <summary>Explicitly converts a double3x4 matrix to a float3x4 matrix by componentwise conversion.</summary>
        /// <param name="v">double3x4 to convert to float3x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Ffloat3x4(Fdouble3x4 v) { return new Ffloat3x4(v); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x4 operator * (Ffloat3x4 lhs, Ffloat3x4 rhs) { return new Ffloat3x4 (lhs.c0 * rhs.c0, lhs.c1 * rhs.c1, lhs.c2 * rhs.c2, lhs.c3 * rhs.c3); }
        ...
        /// <returns>float3x4 result of the componentwise multiplication.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x4 operator * (Ffloat3x4 lhs, float rhs) { return new Ffloat3x4 (lhs.c0 * rhs, lhs.c1 * rhs, lhs.c2 * rhs, lhs.c3 * rhs); }
        ...
        /// <returns>float3x4 result of the componentwise multiplication.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x4 operator * (float lhs, Ffloat3x4 rhs) { return new Ffloat3x4 (lhs * rhs.c0, lhs * rhs.c1, lhs * rhs.c2, lhs * rhs.c3); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x4 operator ++ (Ffloat3x4 val) { return new Ffloat3x4 (++val.c0, ++val.c1, ++val.c2, ++val.c3); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool3x4 operator < (Ffloat3x4 lhs, Ffloat3x4 rhs) { return new Fbool3x4 (lhs.c0 < rhs.c0, lhs.c1 < rhs.c1, lhs.c2 < rhs.c2, lhs.c3 < rhs.c3); }
        ...
        /// <returns>bool3x4 result of the componentwise less than.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool3x4 operator < (Ffloat3x4 lhs, float rhs) { return new Fbool3x4 (lhs.c0 < rhs, lhs.c1 < rhs, lhs.c2 < rhs, lhs.c3 < rhs); }
        ...
        /// <returns>bool3x4 result of the componentwise less than.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool3x4 operator < (float lhs, Ffloat3x4 rhs) { return new Fbool3x4 (lhs < rhs.c0, lhs < rhs.c1, lhs < rhs.c2, lhs < rhs.c3); }
        ...
        unsafe public ref Ffloat3 this[int index]
        {
            get
            {
...
#endif
                fixed (Ffloat3x4* array = &this) { return ref ((Ffloat3*)array)[index]; }
            }
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(Ffloat3x4 rhs) { return c0.Equals(rhs.c0) && c1.Equals(rhs.c1) && c2.Equals(rhs.c2) && c3.Equals(rhs.c3); }

        /// <summary>Returns true if the float3x4 is equal to a given float3x4, false otherwise.</summary>
        /// <param name="o">Right hand side argument to compare equality with.</param>
        /// <returns>The result of the equality comparison.</returns>
        public override bool Equals(object o) { return o is Ffloat3x4 converted && Equals(converted); }
    ...
    public static partial class Fmath
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x4 float3x4(Ffloat3 c0, Ffloat3 c1, Ffloat3 c2, Ffloat3 c3) { return new Ffloat3x4(c0, c1, c2, c3); }
        ...
        /// <returns>float3x4 constructed from arguments.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x4 float3x4(float m00, float m01, float m02, float m03,
                                        float m10, float m11, float m12, float m13,
                                        float m20, float m21, float m22, float m23)
        {
            return new Ffloat3x4(m00, m01, m02, m03,
                                m10, m11, m12, m13,
                                m20, m21, m22, m23);
        }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x4 float3x4(float v) { return new Ffloat3x4(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x4 float3x4(bool v) { return new Ffloat3x4(v); }

        /// <summary>Return a float3x4 matrix constructed from a bool3x4 matrix by componentwise conversion.</summary>
        /// <param name="v">bool3x4 to convert to float3x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x4 float3x4(Fbool3x4 v) { return new Ffloat3x4(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x4 float3x4(int v) { return new Ffloat3x4(v); }

        /// <summary>Return a float3x4 matrix constructed from a int3x4 matrix by componentwise conversion.</summary>
        /// <param name="v">int3x4 to convert to float3x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x4 float3x4(Fint3x4 v) { return new Ffloat3x4(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x4 float3x4(uint v) { return new Ffloat3x4(v); }

        /// <summary>Return a float3x4 matrix constructed from a uint3x4 matrix by componentwise conversion.</summary>
        /// <param name="v">uint3x4 to convert to float3x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x4 float3x4(Fuint3x4 v) { return new Ffloat3x4(v); }
        ...
        public static Ffloat3x4 fastinverse(Ffloat3x4 m)
        {
            Ffloat3 c0 = m.c0;
            Ffloat3 c1 = m.c1;
            Ffloat3 c2 = m.c2;
            ...
            Ffloat3 r0 = float3(c0.x, c1.x, c2.x);
            Ffloat3 r1 = float3(c0.y, c1.y, c2.y);
            Ffloat3 r2 = float3(c0.z, c1.z, c2.z);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint hash(Ffloat3x4 v)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint3 hashwide(Ffloat3x4 v)
        {
