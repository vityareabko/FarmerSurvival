...
namespace Fraktalia.Core.Mathematics
{
    ...
    public partial struct Fint2x4 : System.IEquatable<Fint2x4>, IFormattable
    {
        ...
        public static readonly Fint2x4 zero;
        ...
        public Fint2x4(Fint2 c0, Fint2 c1, Fint2 c2, Fint2 c3)
        {
            this.c0 = c0;
            this.c1 = c1;
            this.c2 = c2;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fint2x4(int m00, int m01, int m02, int m03,
                      int m10, int m11, int m12, int m13)
        {
            this.c0 = new Fint2(m00, m10);
            this.c1 = new Fint2(m01, m11);
            this.c2 = new Fint2(m02, m12);
            this.c3 = new Fint2(m03, m13);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fint2x4(bool v)
        {
            this.c0 = Fmath.select(new Fint2(0), new Fint2(1), v);
            this.c1 = Fmath.select(new Fint2(0), new Fint2(1), v);
            this.c2 = Fmath.select(new Fint2(0), new Fint2(1), v);
            this.c3 = Fmath.select(new Fint2(0), new Fint2(1), v);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fint2x4(Fbool2x4 v)
        {
            this.c0 = Fmath.select(new Fint2(0), new Fint2(1), v.c0);
            this.c1 = Fmath.select(new Fint2(0), new Fint2(1), v.c1);
            this.c2 = Fmath.select(new Fint2(0), new Fint2(1), v.c2);
            this.c3 = Fmath.select(new Fint2(0), new Fint2(1), v.c3);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Fint2x4(int v) { return new Fint2x4(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Fint2x4(bool v) { return new Fint2x4(v); }

        /// <summary>Explicitly converts a bool2x4 matrix to a int2x4 matrix by componentwise conversion.</summary>
        /// <param name="v">bool2x4 to convert to int2x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Fint2x4(Fbool2x4 v) { return new Fint2x4(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Fint2x4(uint v) { return new Fint2x4(v); }

        /// <summary>Explicitly converts a uint2x4 matrix to a int2x4 matrix by componentwise conversion.</summary>
        /// <param name="v">uint2x4 to convert to int2x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Fint2x4(Fuint2x4 v) { return new Fint2x4(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Fint2x4(float v) { return new Fint2x4(v); }

        /// <summary>Explicitly converts a float2x4 matrix to a int2x4 matrix by componentwise conversion.</summary>
        /// <param name="v">float2x4 to convert to int2x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Fint2x4(Ffloat2x4 v) { return new Fint2x4(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Fint2x4(double v) { return new Fint2x4(v); }

        /// <summary>Explicitly converts a double2x4 matrix to a int2x4 matrix by componentwise conversion.</summary>
        /// <param name="v">double2x4 to convert to int2x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Fint2x4(Fdouble2x4 v) { return new Fint2x4(v); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2x4 operator * (Fint2x4 lhs, Fint2x4 rhs) { return new Fint2x4 (lhs.c0 * rhs.c0, lhs.c1 * rhs.c1, lhs.c2 * rhs.c2, lhs.c3 * rhs.c3); }
        ...
        /// <returns>int2x4 result of the componentwise multiplication.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2x4 operator * (Fint2x4 lhs, int rhs) { return new Fint2x4 (lhs.c0 * rhs, lhs.c1 * rhs, lhs.c2 * rhs, lhs.c3 * rhs); }
        ...
        /// <returns>int2x4 result of the componentwise multiplication.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2x4 operator * (int lhs, Fint2x4 rhs) { return new Fint2x4 (lhs * rhs.c0, lhs * rhs.c1, lhs * rhs.c2, lhs * rhs.c3); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2x4 operator ++ (Fint2x4 val) { return new Fint2x4 (++val.c0, ++val.c1, ++val.c2, ++val.c3); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool2x4 operator < (Fint2x4 lhs, Fint2x4 rhs) { return new Fbool2x4 (lhs.c0 < rhs.c0, lhs.c1 < rhs.c1, lhs.c2 < rhs.c2, lhs.c3 < rhs.c3); }
        ...
        /// <returns>bool2x4 result of the componentwise less than.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool2x4 operator < (Fint2x4 lhs, int rhs) { return new Fbool2x4 (lhs.c0 < rhs, lhs.c1 < rhs, lhs.c2 < rhs, lhs.c3 < rhs); }
        ...
        /// <returns>bool2x4 result of the componentwise less than.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool2x4 operator < (int lhs, Fint2x4 rhs) { return new Fbool2x4 (lhs < rhs.c0, lhs < rhs.c1, lhs < rhs.c2, lhs < rhs.c3); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2x4 operator << (Fint2x4 x, int n) { return new Fint2x4 (x.c0 << n, x.c1 << n, x.c2 << n, x.c3 << n); }
        ...
        unsafe public ref Fint2 this[int index]
        {
            get
            {
...
#endif
                fixed (Fint2x4* array = &this) { return ref ((Fint2*)array)[index]; }
            }
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(Fint2x4 rhs) { return c0.Equals(rhs.c0) && c1.Equals(rhs.c1) && c2.Equals(rhs.c2) && c3.Equals(rhs.c3); }

        /// <summary>Returns true if the int2x4 is equal to a given int2x4, false otherwise.</summary>
        /// <param name="o">Right hand side argument to compare equality with.</param>
        /// <returns>The result of the equality comparison.</returns>
        public override bool Equals(object o) { return o is Fint2x4 converted && Equals(converted); }
    ...
    public static partial class Fmath
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2x4 int2x4(Fint2 c0, Fint2 c1, Fint2 c2, Fint2 c3) { return new Fint2x4(c0, c1, c2, c3); }
        ...
        /// <returns>int2x4 constructed from arguments.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2x4 int2x4(int m00, int m01, int m02, int m03,
                                    int m10, int m11, int m12, int m13)
        {
            return new Fint2x4(m00, m01, m02, m03,
                              m10, m11, m12, m13);
        }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2x4 int2x4(int v) { return new Fint2x4(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2x4 int2x4(bool v) { return new Fint2x4(v); }

        /// <summary>Return a int2x4 matrix constructed from a bool2x4 matrix by componentwise conversion.</summary>
        /// <param name="v">bool2x4 to convert to int2x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2x4 int2x4(Fbool2x4 v) { return new Fint2x4(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2x4 int2x4(uint v) { return new Fint2x4(v); }

        /// <summary>Return a int2x4 matrix constructed from a uint2x4 matrix by componentwise conversion.</summary>
        /// <param name="v">uint2x4 to convert to int2x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2x4 int2x4(Fuint2x4 v) { return new Fint2x4(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2x4 int2x4(float v) { return new Fint2x4(v); }

        /// <summary>Return a int2x4 matrix constructed from a float2x4 matrix by componentwise conversion.</summary>
        /// <param name="v">float2x4 to convert to int2x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2x4 int2x4(Ffloat2x4 v) { return new Fint2x4(v); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint hash(Fint2x4 v)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint2 hashwide(Fint2x4 v)
        {
