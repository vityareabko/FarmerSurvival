...
namespace Fraktalia.Core.Mathematics
{
    ...
    public partial struct Fuint4x4 : System.IEquatable<Fuint4x4>, IFormattable
    {
        ...
        public static readonly Fuint4x4 identity = new Fuint4x4(1u, 0u, 0u, 0u,   0u, 1u, 0u, 0u,   0u, 0u, 1u, 0u,   0u, 0u, 0u, 1u);

        /// <summary>uint4x4 zero value.</summary>
        public static readonly Fuint4x4 zero;
        ...
        public Fuint4x4(Fuint4 c0, Fuint4 c1, Fuint4 c2, Fuint4 c3)
        {
            this.c0 = c0;
            this.c1 = c1;
            this.c2 = c2;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fuint4x4(uint m00, uint m01, uint m02, uint m03,
                       uint m10, uint m11, uint m12, uint m13,
                       uint m20, uint m21, uint m22, uint m23,
                       uint m30, uint m31, uint m32, uint m33)
        {
            this.c0 = new Fuint4(m00, m10, m20, m30);
            this.c1 = new Fuint4(m01, m11, m21, m31);
            this.c2 = new Fuint4(m02, m12, m22, m32);
            this.c3 = new Fuint4(m03, m13, m23, m33);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fuint4x4(bool v)
        {
            this.c0 = Fmath.select(new Fuint4(0u), new Fuint4(1u), v);
            this.c1 = Fmath.select(new Fuint4(0u), new Fuint4(1u), v);
            this.c2 = Fmath.select(new Fuint4(0u), new Fuint4(1u), v);
            this.c3 = Fmath.select(new Fuint4(0u), new Fuint4(1u), v);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fuint4x4(Fbool4x4 v)
        {
            this.c0 = Fmath.select(new Fuint4(0u), new Fuint4(1u), v.c0);
            this.c1 = Fmath.select(new Fuint4(0u), new Fuint4(1u), v.c1);
            this.c2 = Fmath.select(new Fuint4(0u), new Fuint4(1u), v.c2);
            this.c3 = Fmath.select(new Fuint4(0u), new Fuint4(1u), v.c3);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Fuint4x4(uint v) { return new Fuint4x4(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Fuint4x4(bool v) { return new Fuint4x4(v); }

        /// <summary>Explicitly converts a bool4x4 matrix to a uint4x4 matrix by componentwise conversion.</summary>
        /// <param name="v">bool4x4 to convert to uint4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Fuint4x4(Fbool4x4 v) { return new Fuint4x4(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Fuint4x4(int v) { return new Fuint4x4(v); }

        /// <summary>Explicitly converts a int4x4 matrix to a uint4x4 matrix by componentwise conversion.</summary>
        /// <param name="v">int4x4 to convert to uint4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Fuint4x4(Fint4x4 v) { return new Fuint4x4(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Fuint4x4(float v) { return new Fuint4x4(v); }

        /// <summary>Explicitly converts a float4x4 matrix to a uint4x4 matrix by componentwise conversion.</summary>
        /// <param name="v">float4x4 to convert to uint4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Fuint4x4(Ffloat4x4 v) { return new Fuint4x4(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Fuint4x4(double v) { return new Fuint4x4(v); }

        /// <summary>Explicitly converts a double4x4 matrix to a uint4x4 matrix by componentwise conversion.</summary>
        /// <param name="v">double4x4 to convert to uint4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Fuint4x4(Fdouble4x4 v) { return new Fuint4x4(v); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint4x4 operator * (Fuint4x4 lhs, Fuint4x4 rhs) { return new Fuint4x4 (lhs.c0 * rhs.c0, lhs.c1 * rhs.c1, lhs.c2 * rhs.c2, lhs.c3 * rhs.c3); }
        ...
        /// <returns>uint4x4 result of the componentwise multiplication.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint4x4 operator * (Fuint4x4 lhs, uint rhs) { return new Fuint4x4 (lhs.c0 * rhs, lhs.c1 * rhs, lhs.c2 * rhs, lhs.c3 * rhs); }
        ...
        /// <returns>uint4x4 result of the componentwise multiplication.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint4x4 operator * (uint lhs, Fuint4x4 rhs) { return new Fuint4x4 (lhs * rhs.c0, lhs * rhs.c1, lhs * rhs.c2, lhs * rhs.c3); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint4x4 operator ++ (Fuint4x4 val) { return new Fuint4x4 (++val.c0, ++val.c1, ++val.c2, ++val.c3); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool4x4 operator < (Fuint4x4 lhs, Fuint4x4 rhs) { return new Fbool4x4 (lhs.c0 < rhs.c0, lhs.c1 < rhs.c1, lhs.c2 < rhs.c2, lhs.c3 < rhs.c3); }
        ...
        /// <returns>bool4x4 result of the componentwise less than.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool4x4 operator < (Fuint4x4 lhs, uint rhs) { return new Fbool4x4 (lhs.c0 < rhs, lhs.c1 < rhs, lhs.c2 < rhs, lhs.c3 < rhs); }
        ...
        /// <returns>bool4x4 result of the componentwise less than.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool4x4 operator < (uint lhs, Fuint4x4 rhs) { return new Fbool4x4 (lhs < rhs.c0, lhs < rhs.c1, lhs < rhs.c2, lhs < rhs.c3); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint4x4 operator << (Fuint4x4 x, int n) { return new Fuint4x4 (x.c0 << n, x.c1 << n, x.c2 << n, x.c3 << n); }
        ...
        unsafe public ref Fuint4 this[int index]
        {
            get
            {
...
#endif
                fixed (Fuint4x4* array = &this) { return ref ((Fuint4*)array)[index]; }
            }
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(Fuint4x4 rhs) { return c0.Equals(rhs.c0) && c1.Equals(rhs.c1) && c2.Equals(rhs.c2) && c3.Equals(rhs.c3); }

        /// <summary>Returns true if the uint4x4 is equal to a given uint4x4, false otherwise.</summary>
        /// <param name="o">Right hand side argument to compare equality with.</param>
        /// <returns>The result of the equality comparison.</returns>
        public override bool Equals(object o) { return o is Fuint4x4 converted && Equals(converted); }
    ...
    public static partial class Fmath
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint4x4 uint4x4(Fuint4 c0, Fuint4 c1, Fuint4 c2, Fuint4 c3) { return new Fuint4x4(c0, c1, c2, c3); }
        ...
        /// <returns>uint4x4 constructed from arguments.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint4x4 uint4x4(uint m00, uint m01, uint m02, uint m03,
                                      uint m10, uint m11, uint m12, uint m13,
                                      uint m20, uint m21, uint m22, uint m23,
                                      uint m30, uint m31, uint m32, uint m33)
        {
            return new Fuint4x4(m00, m01, m02, m03,
                               m10, m11, m12, m13,
                               m20, m21, m22, m23,
                               m30, m31, m32, m33);
        }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint4x4 uint4x4(uint v) { return new Fuint4x4(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint4x4 uint4x4(bool v) { return new Fuint4x4(v); }

        /// <summary>Return a uint4x4 matrix constructed from a bool4x4 matrix by componentwise conversion.</summary>
        /// <param name="v">bool4x4 to convert to uint4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint4x4 uint4x4(Fbool4x4 v) { return new Fuint4x4(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint4x4 uint4x4(int v) { return new Fuint4x4(v); }

        /// <summary>Return a uint4x4 matrix constructed from a int4x4 matrix by componentwise conversion.</summary>
        /// <param name="v">int4x4 to convert to uint4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint4x4 uint4x4(Fint4x4 v) { return new Fuint4x4(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint4x4 uint4x4(float v) { return new Fuint4x4(v); }

        /// <summary>Return a uint4x4 matrix constructed from a float4x4 matrix by componentwise conversion.</summary>
        /// <param name="v">float4x4 to convert to uint4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint4x4 uint4x4(Ffloat4x4 v) { return new Fuint4x4(v); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint hash(Fuint4x4 v)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint4 hashwide(Fuint4x4 v)
        {
