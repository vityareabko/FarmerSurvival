...
namespace Fraktalia.Core.Mathematics
{
    ...
    public static partial class Fmath
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2 asint(Fuint2 x) { return int2((int)x.x, (int)x.y); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint3 asint(Fuint3 x) { return int3((int)x.x, (int)x.y, (int)x.z); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint4 asint(Fuint4 x) { return int4((int)x.x, (int)x.y, (int)x.z, (int)x.w); }
        ...
        /// <returns>The int2 with the same bit pattern as the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2 asint(Ffloat2 x) { return int2(asint(x.x), asint(x.y)); }

        /// <summary>Returns the bit pattern of a float3 as an int3.</summary>
        /// <param name="x">The float3 bits to copy.</param>
        /// <returns>The int3 with the same bit pattern as the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint3 asint(Ffloat3 x) { return int3(asint(x.x), asint(x.y), asint(x.z)); }

        /// <summary>Returns the bit pattern of a float4 as an int4.</summary>
        /// <param name="x">The float4 bits to copy.</param>
        /// <returns>The int4 with the same bit pattern as the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint4 asint(Ffloat4 x) { return int4(asint(x.x), asint(x.y), asint(x.z), asint(x.w)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint2 asuint(Fint2 x) { return uint2((uint)x.x, (uint)x.y); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint3 asuint(Fint3 x) { return uint3((uint)x.x, (uint)x.y, (uint)x.z); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint4 asuint(Fint4 x) { return uint4((uint)x.x, (uint)x.y, (uint)x.z, (uint)x.w); }
        ...
        /// <returns>The uint2 with the same bit pattern as the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint2 asuint(Ffloat2 x) { return uint2(asuint(x.x), asuint(x.y)); }

        /// <summary>Returns the bit pattern of a float3 as a uint3.</summary>
        /// <param name="x">The float3 bits to copy.</param>
        /// <returns>The uint3 with the same bit pattern as the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint3 asuint(Ffloat3 x) { return uint3(asuint(x.x), asuint(x.y), asuint(x.z)); }

        /// <summary>Returns the bit pattern of a float4 as a uint4.</summary>
        /// <param name="x">The float4 bits to copy.</param>
        /// <returns>The uint4 with the same bit pattern as the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint4 asuint(Ffloat4 x) { return uint4(asuint(x.x), asuint(x.y), asuint(x.z), asuint(x.w)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 asfloat(Fint2 x) { return float2(asfloat(x.x), asfloat(x.y)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 asfloat(Fint3 x) { return float3(asfloat(x.x), asfloat(x.y), asfloat(x.z)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 asfloat(Fint4 x) { return float4(asfloat(x.x), asfloat(x.y), asfloat(x.z), asfloat(x.w)); }
        ...
        /// <returns>The float2 with the same bit pattern as the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 asfloat(Fuint2 x) { return float2(asfloat(x.x), asfloat(x.y)); }

        /// <summary>Returns the bit pattern of a uint3 as a float3.</summary>
        /// <param name="x">The uint3 bits to copy.</param>
        /// <returns>The float3 with the same bit pattern as the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 asfloat(Fuint3 x) { return float3(asfloat(x.x), asfloat(x.y), asfloat(x.z)); }

        /// <summary>Returns the bit pattern of a uint4 as a float4.</summary>
        /// <param name="x">The uint4 bits to copy.</param>
        /// <returns>The float4 with the same bit pattern as the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 asfloat(Fuint4 x) { return float4(asfloat(x.x), asfloat(x.y), asfloat(x.z), asfloat(x.w)); }
        ...
        public static int bitmask(Fbool4 value)
        {
            int mask = 0;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool2 isfinite(Ffloat2 x) { return abs(x) < float.PositiveInfinity; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool3 isfinite(Ffloat3 x) { return abs(x) < float.PositiveInfinity; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool4 isfinite(Ffloat4 x) { return abs(x) < float.PositiveInfinity; }
        ...
        /// <returns>A bool2 where it is true in a component if that component is finite, false otherwise.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool2 isfinite(Fdouble2 x) { return abs(x) < double.PositiveInfinity; }
        ...
        /// <returns>A bool3 where it is true in a component if that component is finite, false otherwise.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool3 isfinite(Fdouble3 x) { return abs(x) < double.PositiveInfinity; }
        ...
        /// <returns>A bool4 where it is true in a component if that component is finite, false otherwise.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool4 isfinite(Fdouble4 x) { return abs(x) < double.PositiveInfinity; }
        ...
        /// <returns>True if the component was an infinite value; false otherwise.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool2 isinf(Fdouble2 x) { return abs(x) == double.PositiveInfinity; }
        ...
        /// <returns>True if the component was an infinite value; false otherwise.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool3 isinf(Fdouble3 x) { return abs(x) == double.PositiveInfinity; }
        ...
        /// <returns>True if the component was an infinite value; false otherwise.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool4 isinf(Fdouble4 x) { return abs(x) == double.PositiveInfinity; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool2 isnan(Ffloat2 x) { return (asuint(x) & 0x7FFFFFFF) > 0x7F800000; }
        ...
        /// <returns>True if the component was NaN; false otherwise.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool3 isnan(Ffloat3 x) { return (asuint(x) & 0x7FFFFFFF) > 0x7F800000; }
        ...
        /// <returns>True if the component was NaN; false otherwise.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool4 isnan(Ffloat4 x) { return (asuint(x) & 0x7FFFFFFF) > 0x7F800000; }
        ...
        /// <returns>True if the component was NaN; false otherwise.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool2 isnan(Fdouble2 x) {
        ...
        /// <returns>True if the component was NaN; false otherwise.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool3 isnan(Fdouble3 x)
        {
        ...
        /// <returns>True if the component was NaN; false otherwise.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool4 isnan(Fdouble4 x)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool2 ispow2(Fint2 x)
        {
            return new Fbool2(ispow2(x.x), ispow2(x.y));
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool3 ispow2(Fint3 x)
        {
            return new Fbool3(ispow2(x.x), ispow2(x.y), ispow2(x.z));
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool4 ispow2(Fint4 x)
        {
            return new Fbool4(ispow2(x.x), ispow2(x.y), ispow2(x.z), ispow2(x.w));
        }
        ...
        /// <returns>bool2 where true in a component indicates the same component in the input was a power of two.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool2 ispow2(Fuint2 x)
        {
            return new Fbool2(ispow2(x.x), ispow2(x.y));
        }
        ...
        /// <returns>bool3 where true in a component indicates the same component in the input was a power of two.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool3 ispow2(Fuint3 x)
        {
            return new Fbool3(ispow2(x.x), ispow2(x.y), ispow2(x.z));
        }
        ...
        /// <returns>bool4 where true in a component indicates the same component in the input was a power of two.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool4 ispow2(Fuint4 x)
        {
            return new Fbool4(ispow2(x.x), ispow2(x.y), ispow2(x.z), ispow2(x.w));
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2 min(Fint2 x, Fint2 y) { return new Fint2(min(x.x, y.x), min(x.y, y.y)); }
        ...
        /// <returns>The componentwise minimum of the two input values.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint3 min(Fint3 x, Fint3 y) { return new Fint3(min(x.x, y.x), min(x.y, y.y), min(x.z, y.z)); }
        ...
        /// <returns>The componentwise minimum of the two input values.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint4 min(Fint4 x, Fint4 y) { return new Fint4(min(x.x, y.x), min(x.y, y.y), min(x.z, y.z), min(x.w, y.w)); }
        ...
        /// <returns>The componentwise minimum of the two input values.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint2 min(Fuint2 x, Fuint2 y) { return new Fuint2(min(x.x, y.x), min(x.y, y.y)); }
        ...
        /// <returns>The componentwise minimum of the two input values.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint3 min(Fuint3 x, Fuint3 y) { return new Fuint3(min(x.x, y.x), min(x.y, y.y), min(x.z, y.z)); }
        ...
        /// <returns>The componentwise minimum of the two input values.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint4 min(Fuint4 x, Fuint4 y) { return new Fuint4(min(x.x, y.x), min(x.y, y.y), min(x.z, y.z), min(x.w, y.w)); }
        ...
        /// <returns>The componentwise minimum of the two input values.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 min(Ffloat2 x, Ffloat2 y) { return new Ffloat2(min(x.x, y.x), min(x.y, y.y)); }
        ...
        /// <returns>The componentwise minimum of the two input values.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 min(Ffloat3 x, Ffloat3 y) { return new Ffloat3(min(x.x, y.x), min(x.y, y.y), min(x.z, y.z)); }
        ...
        /// <returns>The componentwise minimum of the two input values.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 min(Ffloat4 x, Ffloat4 y) { return new Ffloat4(min(x.x, y.x), min(x.y, y.y), min(x.z, y.z), min(x.w, y.w)); }
        ...
        /// <returns>The componentwise minimum of the two input values.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 min(Fdouble2 x, Fdouble2 y) { return new Fdouble2(min(x.x, y.x), min(x.y, y.y)); }
        ...
        /// <returns>The componentwise minimum of the two input values.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 min(Fdouble3 x, Fdouble3 y) { return new Fdouble3(min(x.x, y.x), min(x.y, y.y), min(x.z, y.z)); }
        ...
        /// <returns>The componentwise minimum of the two input values.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 min(Fdouble4 x, Fdouble4 y) { return new Fdouble4(min(x.x, y.x), min(x.y, y.y), min(x.z, y.z), min(x.w, y.w)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2 max(Fint2 x, Fint2 y) { return new Fint2(max(x.x, y.x), max(x.y, y.y)); }
        ...
        /// <returns>The componentwise maximum of the two input values.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint3 max(Fint3 x, Fint3 y) { return new Fint3(max(x.x, y.x), max(x.y, y.y), max(x.z, y.z)); }
        ...
        /// <returns>The componentwise maximum of the two input values.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint4 max(Fint4 x, Fint4 y) { return new Fint4(max(x.x, y.x), max(x.y, y.y), max(x.z, y.z), max(x.w, y.w)); }
        ...
        /// <returns>The componentwise maximum of the two input values.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint2 max(Fuint2 x, Fuint2 y) { return new Fuint2(max(x.x, y.x), max(x.y, y.y)); }
        ...
        /// <returns>The componentwise maximum of the two input values.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint3 max(Fuint3 x, Fuint3 y) { return new Fuint3(max(x.x, y.x), max(x.y, y.y), max(x.z, y.z)); }
        ...
        /// <returns>The componentwise maximum of the two input values.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint4 max(Fuint4 x, Fuint4 y) { return new Fuint4(max(x.x, y.x), max(x.y, y.y), max(x.z, y.z), max(x.w, y.w)); }
        ...
        /// <returns>The componentwise maximum of the two input values.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 max(Ffloat2 x, Ffloat2 y) { return new Ffloat2(max(x.x, y.x), max(x.y, y.y)); }
        ...
        /// <returns>The componentwise maximum of the two input values.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 max(Ffloat3 x, Ffloat3 y) { return new Ffloat3(max(x.x, y.x), max(x.y, y.y), max(x.z, y.z)); }
        ...
        /// <returns>The componentwise maximum of the two input values.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 max(Ffloat4 x, Ffloat4 y) { return new Ffloat4(max(x.x, y.x), max(x.y, y.y), max(x.z, y.z), max(x.w, y.w)); }
        ...
        /// <returns>The componentwise maximum of the two input values.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 max(Fdouble2 x, Fdouble2 y) { return new Fdouble2(max(x.x, y.x), max(x.y, y.y)); }
        ...
        /// <returns>The componentwise maximum of the two input values.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 max(Fdouble3 x, Fdouble3 y) { return new Fdouble3(max(x.x, y.x), max(x.y, y.y), max(x.z, y.z)); }
        ...
        /// <returns>The componentwise maximum of the two input values.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 max(Fdouble4 x, Fdouble4 y) { return new Fdouble4(max(x.x, y.x), max(x.y, y.y), max(x.z, y.z), max(x.w, y.w)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 lerp(Ffloat2 x, Ffloat2 y, float s) { return x + s * (y - x); }
        ...
        /// <returns>The componentwise interpolation from x to y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 lerp(Ffloat3 x, Ffloat3 y, float s) { return x + s * (y - x); }
        ...
        /// <returns>The componentwise interpolation from x to y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 lerp(Ffloat4 x, Ffloat4 y, float s) { return x + s * (y - x); }
        ...
        /// <returns>The componentwise interpolation from x to y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 lerp(Ffloat2 x, Ffloat2 y, Ffloat2 s) { return x + s * (y - x); }
        ...
        /// <returns>The componentwise interpolation from x to y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 lerp(Ffloat3 x, Ffloat3 y, Ffloat3 s) { return x + s * (y - x); }
        ...
        /// <returns>The componentwise interpolation from x to y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 lerp(Ffloat4 x, Ffloat4 y, Ffloat4 s) { return x + s * (y - x); }
        ...
        /// <returns>The componentwise interpolation from x to y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 lerp(Fdouble2 x, Fdouble2 y, double s) { return x + s * (y - x); }
        ...
        /// <returns>The componentwise interpolation from x to y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 lerp(Fdouble3 x, Fdouble3 y, double s) { return x + s * (y - x); }
        ...
        /// <returns>The componentwise interpolation from x to y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 lerp(Fdouble4 x, Fdouble4 y, double s) { return x + s * (y - x); }
        ...
        /// <returns>The componentwise interpolation from x to y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 lerp(Fdouble2 x, Fdouble2 y, Fdouble2 s) { return x + s * (y - x); }
        ...
        /// <returns>The componentwise interpolation from x to y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 lerp(Fdouble3 x, Fdouble3 y, Fdouble3 s) { return x + s * (y - x); }
        ...
        /// <returns>The componentwise interpolation from x to y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 lerp(Fdouble4 x, Fdouble4 y, Fdouble4 s) { return x + s * (y - x); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 unlerp(Ffloat2 a, Ffloat2 b, Ffloat2 x) { return (x - a) / (b - a); }
        ...
        /// <returns>The componentwise interpolation parameter of x with respect to the input range [a, b].</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 unlerp(Ffloat3 a, Ffloat3 b, Ffloat3 x) { return (x - a) / (b - a); }
        ...
        /// <returns>The componentwise interpolation parameter of x with respect to the input range [a, b].</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 unlerp(Ffloat4 a, Ffloat4 b, Ffloat4 x) { return (x - a) / (b - a); }
        ...
        /// <returns>The componentwise interpolation parameter of x with respect to the input range [a, b].</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 unlerp(Fdouble2 a, Fdouble2 b, Fdouble2 x) { return (x - a) / (b - a); }
        ...
        /// <returns>The componentwise interpolation parameter of x with respect to the input range [a, b].</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 unlerp(Fdouble3 a, Fdouble3 b, Fdouble3 x) { return (x - a) / (b - a); }
        ...
        /// <returns>The componentwise interpolation parameter of x with respect to the input range [a, b].</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 unlerp(Fdouble4 a, Fdouble4 b, Fdouble4 x) { return (x - a) / (b - a); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 remap(Ffloat2 a, Ffloat2 b, Ffloat2 c, Ffloat2 d, Ffloat2 x) { return lerp(c, d, unlerp(a, b, x)); }
        ...
        /// <returns>The componentwise remap of input x from the source range to the destination range.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 remap(Ffloat3 a, Ffloat3 b, Ffloat3 c, Ffloat3 d, Ffloat3 x) { return lerp(c, d, unlerp(a, b, x)); }
        ...
        /// <returns>The componentwise remap of input x from the source range to the destination range.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 remap(Ffloat4 a, Ffloat4 b, Ffloat4 c, Ffloat4 d, Ffloat4 x) { return lerp(c, d, unlerp(a, b, x)); }
        ...
        /// <returns>The componentwise remap of input x from the source range to the destination range.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 remap(Fdouble2 a, Fdouble2 b, Fdouble2 c, Fdouble2 d, Fdouble2 x) { return lerp(c, d, unlerp(a, b, x)); }
        ...
        /// <returns>The componentwise remap of input x from the source range to the destination range.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 remap(Fdouble3 a, Fdouble3 b, Fdouble3 c, Fdouble3 d, Fdouble3 x) { return lerp(c, d, unlerp(a, b, x)); }
        ...
        /// <returns>The componentwise remap of input x from the source range to the destination range.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 remap(Fdouble4 a, Fdouble4 b, Fdouble4 c, Fdouble4 d, Fdouble4 x) { return lerp(c, d, unlerp(a, b, x)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2 mad(Fint2 a, Fint2 b, Fint2 c) { return a * b + c; }
        ...
        /// <returns>The componentwise multiply-add of the inputs.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint3 mad(Fint3 a, Fint3 b, Fint3 c) { return a * b + c; }
        ...
        /// <returns>The componentwise multiply-add of the inputs.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint4 mad(Fint4 a, Fint4 b, Fint4 c) { return a * b + c; }
        ...
        /// <returns>The componentwise multiply-add of the inputs.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint2 mad(Fuint2 a, Fuint2 b, Fuint2 c) { return a * b + c; }
        ...
        /// <returns>The componentwise multiply-add of the inputs.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint3 mad(Fuint3 a, Fuint3 b, Fuint3 c) { return a * b + c; }
        ...
        /// <returns>The componentwise multiply-add of the inputs.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint4 mad(Fuint4 a, Fuint4 b, Fuint4 c) { return a * b + c; }
        ...
        /// <returns>The componentwise multiply-add of the inputs.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 mad(Ffloat2 a, Ffloat2 b, Ffloat2 c) { return a * b + c; }
        ...
        /// <returns>The componentwise multiply-add of the inputs.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 mad(Ffloat3 a, Ffloat3 b, Ffloat3 c) { return a * b + c; }
        ...
        /// <returns>The componentwise multiply-add of the inputs.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 mad(Ffloat4 a, Ffloat4 b, Ffloat4 c) { return a * b + c; }
        ...
        /// <returns>The componentwise multiply-add of the inputs.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 mad(Fdouble2 a, Fdouble2 b, Fdouble2 c) { return a * b + c; }
        ...
        /// <returns>The componentwise multiply-add of the inputs.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 mad(Fdouble3 a, Fdouble3 b, Fdouble3 c) { return a * b + c; }
        ...
        /// <returns>The componentwise multiply-add of the inputs.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 mad(Fdouble4 a, Fdouble4 b, Fdouble4 c) { return a * b + c; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2 clamp(Fint2 x, Fint2 a, Fint2 b) { return max(a, min(b, x)); }
        ...
        /// <returns>The componentwise clamping of the input x into the interval [a, b].</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint3 clamp(Fint3 x, Fint3 a, Fint3 b) { return max(a, min(b, x)); }
        ...
        /// <returns>The componentwise clamping of the input x into the interval [a, b].</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint4 clamp(Fint4 x, Fint4 a, Fint4 b) { return max(a, min(b, x)); }
        ...
        /// <returns>The componentwise clamping of the input x into the interval [a, b].</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint2 clamp(Fuint2 x, Fuint2 a, Fuint2 b) { return max(a, min(b, x)); }
        ...
        /// <returns>The componentwise clamping of the input x into the interval [a, b].</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint3 clamp(Fuint3 x, Fuint3 a, Fuint3 b) { return max(a, min(b, x)); }
        ...
        /// <returns>The componentwise clamping of the input x into the interval [a, b].</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint4 clamp(Fuint4 x, Fuint4 a, Fuint4 b) { return max(a, min(b, x)); }
        ...
        /// <returns>The componentwise clamping of the input x into the interval [a, b].</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 clamp(Ffloat2 x, Ffloat2 a, Ffloat2 b) { return max(a, min(b, x)); }
        ...
        /// <returns>The componentwise clamping of the input x into the interval [a, b].</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 clamp(Ffloat3 x, Ffloat3 a, Ffloat3 b) { return max(a, min(b, x)); }
        ...
        /// <returns>The componentwise clamping of the input x into the interval [a, b].</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 clamp(Ffloat4 x, Ffloat4 a, Ffloat4 b) { return max(a, min(b, x)); }
        ...
        /// <returns>The componentwise clamping of the input x into the interval [a, b].</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 clamp(Fdouble2 x, Fdouble2 a, Fdouble2 b) { return max(a, min(b, x)); }
        ...
        /// <returns>The componentwise clamping of the input x into the interval [a, b].</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 clamp(Fdouble3 x, Fdouble3 a, Fdouble3 b) { return max(a, min(b, x)); }
        ...
        /// <returns>The componentwise clamping of the input x into the interval [a, b].</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 clamp(Fdouble4 x, Fdouble4 a, Fdouble4 b) { return max(a, min(b, x)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 saturate(Ffloat2 x) { return clamp(x, new Ffloat2(0.0f), new Ffloat2(1.0f)); }

        /// <summary>Returns the result of a componentwise clamping of the float3 vector x into the interval [0, 1].</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise clamping of the input into the interval [0, 1].</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 saturate(Ffloat3 x) { return clamp(x, new Ffloat3(0.0f), new Ffloat3(1.0f)); }

        /// <summary>Returns the result of a componentwise clamping of the float4 vector x into the interval [0, 1].</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise clamping of the input into the interval [0, 1].</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 saturate(Ffloat4 x) { return clamp(x, new Ffloat4(0.0f), new Ffloat4(1.0f)); }
        ...
        /// <returns>The componentwise clamping of the input into the interval [0, 1].</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 saturate(Fdouble2 x) { return clamp(x, new Fdouble2(0.0), new Fdouble2(1.0)); }

        /// <summary>Returns the result of a componentwise clamping of the double3 vector x into the interval [0, 1].</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise clamping of the input into the interval [0, 1].</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 saturate(Fdouble3 x) { return clamp(x, new Fdouble3(0.0), new Fdouble3(1.0)); }

        /// <summary>Returns the result of a componentwise clamping of the double4 vector x into the interval [0, 1].</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise clamping of the input into the interval [0, 1].</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 saturate(Fdouble4 x) { return clamp(x, new Fdouble4(0.0), new Fdouble4(1.0)); }
        ...
        /// <returns>The componentwise absolute value of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 abs(Ffloat2 x) { return asfloat(asuint(x) & 0x7FFFFFFF); }

        /// <summary>Returns the componentwise absolute value of a float3 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise absolute value of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 abs(Ffloat3 x) { return asfloat(asuint(x) & 0x7FFFFFFF); }

        /// <summary>Returns the componentwise absolute value of a float4 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise absolute value of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 abs(Ffloat4 x) { return asfloat(asuint(x) & 0x7FFFFFFF); }
        ...
        /// <returns>The componentwise absolute value of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 abs(Fdouble2 x) { return double2(asdouble(asulong(x.x) & 0x7FFFFFFFFFFFFFFF), asdouble(asulong(x.y) & 0x7FFFFFFFFFFFFFFF)); }

        /// <summary>Returns the componentwise absolute value of a double3 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise absolute value of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 abs(Fdouble3 x) { return double3(asdouble(asulong(x.x) & 0x7FFFFFFFFFFFFFFF), asdouble(asulong(x.y) & 0x7FFFFFFFFFFFFFFF), asdouble(asulong(x.z) & 0x7FFFFFFFFFFFFFFF)); }

        /// <summary>Returns the componentwise absolute value of a double4 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise absolute value of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 abs(Fdouble4 x) { return double4(asdouble(asulong(x.x) & 0x7FFFFFFFFFFFFFFF), asdouble(asulong(x.y) & 0x7FFFFFFFFFFFFFFF), asdouble(asulong(x.z) & 0x7FFFFFFFFFFFFFFF), asdouble(asulong(x.w) & 0x7FFFFFFFFFFFFFFF)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int dot(Fint2 x, Fint2 y) { return x.x * y.x + x.y * y.y; }
        ...
        /// <returns>The dot product of two vectors.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int dot(Fint3 x, Fint3 y) { return x.x * y.x + x.y * y.y + x.z * y.z; }
        ...
        /// <returns>The dot product of two vectors.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int dot(Fint4 x, Fint4 y) { return x.x * y.x + x.y * y.y + x.z * y.z + x.w * y.w; }
        ...
        /// <returns>The dot product of two vectors.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint dot(Fuint2 x, Fuint2 y) { return x.x * y.x + x.y * y.y; }
        ...
        /// <returns>The dot product of two vectors.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint dot(Fuint3 x, Fuint3 y) { return x.x * y.x + x.y * y.y + x.z * y.z; }
        ...
        /// <returns>The dot product of two vectors.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint dot(Fuint4 x, Fuint4 y) { return x.x * y.x + x.y * y.y + x.z * y.z + x.w * y.w; }
        ...
        /// <returns>The dot product of two vectors.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float dot(Ffloat2 x, Ffloat2 y) { return x.x * y.x + x.y * y.y; }
        ...
        /// <returns>The dot product of two vectors.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float dot(Ffloat3 x, Ffloat3 y) { return x.x * y.x + x.y * y.y + x.z * y.z; }
        ...
        /// <returns>The dot product of two vectors.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float dot(Ffloat4 x, Ffloat4 y) { return x.x * y.x + x.y * y.y + x.z * y.z + x.w * y.w; }
        ...
        /// <returns>The dot product of two vectors.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double dot(Fdouble2 x, Fdouble2 y) { return x.x * y.x + x.y * y.y; }
        ...
        /// <returns>The dot product of two vectors.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double dot(Fdouble3 x, Fdouble3 y) { return x.x * y.x + x.y * y.y + x.z * y.z; }
        ...
        /// <returns>The dot product of two vectors.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double dot(Fdouble4 x, Fdouble4 y) { return x.x * y.x + x.y * y.y + x.z * y.z + x.w * y.w; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 tan(Ffloat2 x) { return new Ffloat2(tan(x.x), tan(x.y)); }

        /// <summary>Returns the componentwise tangent of a float3 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise tangent of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 tan(Ffloat3 x) { return new Ffloat3(tan(x.x), tan(x.y), tan(x.z)); }

        /// <summary>Returns the componentwise tangent of a float4 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise tangent of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 tan(Ffloat4 x) { return new Ffloat4(tan(x.x), tan(x.y), tan(x.z), tan(x.w)); }
        ...
        /// <returns>The componentwise tangent of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 tan(Fdouble2 x) { return new Fdouble2(tan(x.x), tan(x.y)); }

        /// <summary>Returns the componentwise tangent of a double3 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise tangent of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 tan(Fdouble3 x) { return new Fdouble3(tan(x.x), tan(x.y), tan(x.z)); }

        /// <summary>Returns the componentwise tangent of a double4 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise tangent of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 tan(Fdouble4 x) { return new Fdouble4(tan(x.x), tan(x.y), tan(x.z), tan(x.w)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 tanh(Ffloat2 x) { return new Ffloat2(tanh(x.x), tanh(x.y)); }

        /// <summary>Returns the componentwise hyperbolic tangent of a float3 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise hyperbolic tangent of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 tanh(Ffloat3 x) { return new Ffloat3(tanh(x.x), tanh(x.y), tanh(x.z)); }

        /// <summary>Returns the componentwise hyperbolic tangent of a float4 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise hyperbolic tangent of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 tanh(Ffloat4 x) { return new Ffloat4(tanh(x.x), tanh(x.y), tanh(x.z), tanh(x.w)); }
        ...
        /// <returns>The componentwise hyperbolic tangent of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 tanh(Fdouble2 x) { return new Fdouble2(tanh(x.x), tanh(x.y)); }

        /// <summary>Returns the componentwise hyperbolic tangent of a double3 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise hyperbolic tangent of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 tanh(Fdouble3 x) { return new Fdouble3(tanh(x.x), tanh(x.y), tanh(x.z)); }

        /// <summary>Returns the componentwise hyperbolic tangent of a double4 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise hyperbolic tangent of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 tanh(Fdouble4 x) { return new Fdouble4(tanh(x.x), tanh(x.y), tanh(x.z), tanh(x.w)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 atan(Ffloat2 x) { return new Ffloat2(atan(x.x), atan(x.y)); }

        /// <summary>Returns the componentwise arctangent of a float3 vector.</summary>
        /// <param name="x">A tangent value, usually the ratio y/x on the unit circle.</param>
        /// <returns>The componentwise arctangent of the input, in radians.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 atan(Ffloat3 x) { return new Ffloat3(atan(x.x), atan(x.y), atan(x.z)); }

        /// <summary>Returns the componentwise arctangent of a float4 vector.</summary>
        /// <param name="x">A tangent value, usually the ratio y/x on the unit circle.</param>
        /// <returns>The componentwise arctangent of the input, in radians.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 atan(Ffloat4 x) { return new Ffloat4(atan(x.x), atan(x.y), atan(x.z), atan(x.w)); }
        ...
        /// <returns>The componentwise arctangent of the input, in radians.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 atan(Fdouble2 x) { return new Fdouble2(atan(x.x), atan(x.y)); }

        /// <summary>Returns the componentwise arctangent of a double3 vector.</summary>
        /// <param name="x">A tangent value, usually the ratio y/x on the unit circle.</param>
        /// <returns>The componentwise arctangent of the input, in radians.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 atan(Fdouble3 x) { return new Fdouble3(atan(x.x), atan(x.y), atan(x.z)); }

        /// <summary>Returns the componentwise arctangent of a double4 vector.</summary>
        /// <param name="x">A tangent value, usually the ratio y/x on the unit circle.</param>
        /// <returns>The componentwise arctangent of the input, in radians.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 atan(Fdouble4 x) { return new Fdouble4(atan(x.x), atan(x.y), atan(x.z), atan(x.w)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 atan2(Ffloat2 y, Ffloat2 x) { return new Ffloat2(atan2(y.x, x.x), atan2(y.y, x.y)); }
        ...
        /// <returns>The componentwise arctangent of the ratio y/x, in radians.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 atan2(Ffloat3 y, Ffloat3 x) { return new Ffloat3(atan2(y.x, x.x), atan2(y.y, x.y), atan2(y.z, x.z)); }
        ...
        /// <returns>The componentwise arctangent of the ratio y/x, in radians.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 atan2(Ffloat4 y, Ffloat4 x) { return new Ffloat4(atan2(y.x, x.x), atan2(y.y, x.y), atan2(y.z, x.z), atan2(y.w, x.w)); }
        ...
        /// <returns>The componentwise arctangent of the ratio y/x, in radians.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 atan2(Fdouble2 y, Fdouble2 x) { return new Fdouble2(atan2(y.x, x.x), atan2(y.y, x.y)); }
        ...
        /// <returns>The componentwise arctangent of the ratio y/x, in radians.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 atan2(Fdouble3 y, Fdouble3 x) { return new Fdouble3(atan2(y.x, x.x), atan2(y.y, x.y), atan2(y.z, x.z)); }
        ...
        /// <returns>The componentwise arctangent of the ratio y/x, in radians.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 atan2(Fdouble4 y, Fdouble4 x) { return new Fdouble4(atan2(y.x, x.x), atan2(y.y, x.y), atan2(y.z, x.z), atan2(y.w, x.w)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 cos(Ffloat2 x) { return new Ffloat2(cos(x.x), cos(x.y)); }

        /// <summary>Returns the componentwise cosine of a float3 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise cosine cosine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 cos(Ffloat3 x) { return new Ffloat3(cos(x.x), cos(x.y), cos(x.z)); }

        /// <summary>Returns the componentwise cosine of a float4 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise cosine cosine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 cos(Ffloat4 x) { return new Ffloat4(cos(x.x), cos(x.y), cos(x.z), cos(x.w)); }
        ...
        /// <returns>The componentwise cosine cosine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 cos(Fdouble2 x) { return new Fdouble2(cos(x.x), cos(x.y)); }

        /// <summary>Returns the componentwise cosine of a double3 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise cosine cosine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 cos(Fdouble3 x) { return new Fdouble3(cos(x.x), cos(x.y), cos(x.z)); }

        /// <summary>Returns the componentwise cosine of a double4 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise cosine cosine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 cos(Fdouble4 x) { return new Fdouble4(cos(x.x), cos(x.y), cos(x.z), cos(x.w)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 cosh(Ffloat2 x) { return new Ffloat2(cosh(x.x), cosh(x.y)); }

        /// <summary>Returns the componentwise hyperbolic cosine of a float3 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise hyperbolic cosine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 cosh(Ffloat3 x) { return new Ffloat3(cosh(x.x), cosh(x.y), cosh(x.z)); }

        /// <summary>Returns the componentwise hyperbolic cosine of a float4 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise hyperbolic cosine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 cosh(Ffloat4 x) { return new Ffloat4(cosh(x.x), cosh(x.y), cosh(x.z), cosh(x.w)); }
        ...
        /// <returns>The componentwise hyperbolic cosine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 cosh(Fdouble2 x) { return new Fdouble2(cosh(x.x), cosh(x.y)); }

        /// <summary>Returns the componentwise hyperbolic cosine of a double3 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise hyperbolic cosine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 cosh(Fdouble3 x) { return new Fdouble3(cosh(x.x), cosh(x.y), cosh(x.z)); }

        /// <summary>Returns the componentwise hyperbolic cosine of a double4 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise hyperbolic cosine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 cosh(Fdouble4 x) { return new Fdouble4(cosh(x.x), cosh(x.y), cosh(x.z), cosh(x.w)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 acos(Ffloat2 x) { return new Ffloat2(acos(x.x), acos(x.y)); }

        /// <summary>Returns the componentwise arccosine of a float3 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise arccosine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 acos(Ffloat3 x) { return new Ffloat3(acos(x.x), acos(x.y), acos(x.z)); }

        /// <summary>Returns the componentwise arccosine of a float4 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise arccosine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 acos(Ffloat4 x) { return new Ffloat4(acos(x.x), acos(x.y), acos(x.z), acos(x.w)); }
        ...
        /// <returns>The componentwise arccosine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 acos(Fdouble2 x) { return new Fdouble2(acos(x.x), acos(x.y)); }

        /// <summary>Returns the componentwise arccosine of a double3 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise arccosine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 acos(Fdouble3 x) { return new Fdouble3(acos(x.x), acos(x.y), acos(x.z)); }

        /// <summary>Returns the componentwise arccosine of a double4 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise arccosine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 acos(Fdouble4 x) { return new Fdouble4(acos(x.x), acos(x.y), acos(x.z), acos(x.w)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 sin(Ffloat2 x) { return new Ffloat2(sin(x.x), sin(x.y)); }

        /// <summary>Returns the componentwise sine of a float3 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise sine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 sin(Ffloat3 x) { return new Ffloat3(sin(x.x), sin(x.y), sin(x.z)); }

        /// <summary>Returns the componentwise sine of a float4 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise sine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 sin(Ffloat4 x) { return new Ffloat4(sin(x.x), sin(x.y), sin(x.z), sin(x.w)); }
        ...
        /// <returns>The componentwise sine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 sin(Fdouble2 x) { return new Fdouble2(sin(x.x), sin(x.y)); }

        /// <summary>Returns the componentwise sine of a double3 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise sine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 sin(Fdouble3 x) { return new Fdouble3(sin(x.x), sin(x.y), sin(x.z)); }

        /// <summary>Returns the componentwise sine of a double4 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise sine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 sin(Fdouble4 x) { return new Fdouble4(sin(x.x), sin(x.y), sin(x.z), sin(x.w)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 sinh(Ffloat2 x) { return new Ffloat2(sinh(x.x), sinh(x.y)); }

        /// <summary>Returns the componentwise hyperbolic sine of a float3 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise hyperbolic sine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 sinh(Ffloat3 x) { return new Ffloat3(sinh(x.x), sinh(x.y), sinh(x.z)); }

        /// <summary>Returns the componentwise hyperbolic sine of a float4 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise hyperbolic sine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 sinh(Ffloat4 x) { return new Ffloat4(sinh(x.x), sinh(x.y), sinh(x.z), sinh(x.w)); }
        ...
        /// <returns>The componentwise hyperbolic sine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 sinh(Fdouble2 x) { return new Fdouble2(sinh(x.x), sinh(x.y)); }

        /// <summary>Returns the componentwise hyperbolic sine of a double3 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise hyperbolic sine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 sinh(Fdouble3 x) { return new Fdouble3(sinh(x.x), sinh(x.y), sinh(x.z)); }

        /// <summary>Returns the componentwise hyperbolic sine of a double4 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise hyperbolic sine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 sinh(Fdouble4 x) { return new Fdouble4(sinh(x.x), sinh(x.y), sinh(x.z), sinh(x.w)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 asin(Ffloat2 x) { return new Ffloat2(asin(x.x), asin(x.y)); }

        /// <summary>Returns the componentwise arcsine of a float3 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise arcsine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 asin(Ffloat3 x) { return new Ffloat3(asin(x.x), asin(x.y), asin(x.z)); }

        /// <summary>Returns the componentwise arcsine of a float4 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise arcsine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 asin(Ffloat4 x) { return new Ffloat4(asin(x.x), asin(x.y), asin(x.z), asin(x.w)); }
        ...
        /// <returns>The componentwise arcsine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 asin(Fdouble2 x) { return new Fdouble2(asin(x.x), asin(x.y)); }

        /// <summary>Returns the componentwise arcsine of a double3 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise arcsine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 asin(Fdouble3 x) { return new Fdouble3(asin(x.x), asin(x.y), asin(x.z)); }

        /// <summary>Returns the componentwise arcsine of a double4 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise arcsine of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 asin(Fdouble4 x) { return new Fdouble4(asin(x.x), asin(x.y), asin(x.z), asin(x.w)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 floor(Ffloat2 x) { return new Ffloat2(floor(x.x), floor(x.y)); }
        ...
        /// <returns>The componentwise round down to nearest integral value of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 floor(Ffloat3 x) { return new Ffloat3(floor(x.x), floor(x.y), floor(x.z)); }
        ...
        /// <returns>The componentwise round down to nearest integral value of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 floor(Ffloat4 x) { return new Ffloat4(floor(x.x), floor(x.y), floor(x.z), floor(x.w)); }
        ...
        /// <returns>The componentwise round down to nearest integral value of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 floor(Fdouble2 x) { return new Fdouble2(floor(x.x), floor(x.y)); }
        ...
        /// <returns>The componentwise round down to nearest integral value of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 floor(Fdouble3 x) { return new Fdouble3(floor(x.x), floor(x.y), floor(x.z)); }
        ...
        /// <returns>The componentwise round down to nearest integral value of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 floor(Fdouble4 x) { return new Fdouble4(floor(x.x), floor(x.y), floor(x.z), floor(x.w)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 ceil(Ffloat2 x) { return new Ffloat2(ceil(x.x), ceil(x.y)); }
        ...
        /// <returns>The componentwise round up to nearest integral value of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 ceil(Ffloat3 x) { return new Ffloat3(ceil(x.x), ceil(x.y), ceil(x.z)); }
        ...
        /// <returns>The componentwise round up to nearest integral value of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 ceil(Ffloat4 x) { return new Ffloat4(ceil(x.x), ceil(x.y), ceil(x.z), ceil(x.w)); }
        ...
        /// <returns>The componentwise round up to nearest integral value of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 ceil(Fdouble2 x) { return new Fdouble2(ceil(x.x), ceil(x.y)); }
        ...
        /// <returns>The componentwise round up to nearest integral value of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 ceil(Fdouble3 x) { return new Fdouble3(ceil(x.x), ceil(x.y), ceil(x.z)); }
        ...
        /// <returns>The componentwise round up to nearest integral value of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 ceil(Fdouble4 x) { return new Fdouble4(ceil(x.x), ceil(x.y), ceil(x.z), ceil(x.w)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 round(Ffloat2 x) { return new Ffloat2(round(x.x), round(x.y)); }

        /// <summary>Returns the result of rounding each component of a float3 vector value to the nearest integral value.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise round to nearest integral value of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 round(Ffloat3 x) { return new Ffloat3(round(x.x), round(x.y), round(x.z)); }

        /// <summary>Returns the result of rounding each component of a float4 vector value to the nearest integral value.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise round to nearest integral value of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 round(Ffloat4 x) { return new Ffloat4(round(x.x), round(x.y), round(x.z), round(x.w)); }
        ...
        /// <returns>The componentwise round to nearest integral value of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 round(Fdouble2 x) { return new Fdouble2(round(x.x), round(x.y)); }

        /// <summary>Returns the result of rounding each component of a double3 vector value to the nearest integral value.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise round to nearest integral value of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 round(Fdouble3 x) { return new Fdouble3(round(x.x), round(x.y), round(x.z)); }

        /// <summary>Returns the result of rounding each component of a double4 vector value to the nearest integral value.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise round to nearest integral value of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 round(Fdouble4 x) { return new Fdouble4(round(x.x), round(x.y), round(x.z), round(x.w)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 trunc(Ffloat2 x) { return new Ffloat2(trunc(x.x), trunc(x.y)); }

        /// <summary>Returns the result of a componentwise truncation of a float3 value to an integral float3 value.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise truncation of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 trunc(Ffloat3 x) { return new Ffloat3(trunc(x.x), trunc(x.y), trunc(x.z)); }

        /// <summary>Returns the result of a componentwise truncation of a float4 value to an integral float4 value.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise truncation of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 trunc(Ffloat4 x) { return new Ffloat4(trunc(x.x), trunc(x.y), trunc(x.z), trunc(x.w)); }
        ...
        /// <returns>The componentwise truncation of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 trunc(Fdouble2 x) { return new Fdouble2(trunc(x.x), trunc(x.y)); }

        /// <summary>Returns the result of a componentwise truncation of a double3 value to an integral double3 value.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise truncation of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 trunc(Fdouble3 x) { return new Fdouble3(trunc(x.x), trunc(x.y), trunc(x.z)); }

        /// <summary>Returns the result of a componentwise truncation of a double4 value to an integral double4 value.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise truncation of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 trunc(Fdouble4 x) { return new Fdouble4(trunc(x.x), trunc(x.y), trunc(x.z), trunc(x.w)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 frac(Ffloat2 x) { return x - floor(x); }

        /// <summary>Returns the componentwise fractional parts of a float3 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise fractional part of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 frac(Ffloat3 x) { return x - floor(x); }

        /// <summary>Returns the componentwise fractional parts of a float4 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise fractional part of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 frac(Ffloat4 x) { return x - floor(x); }
        ...
        /// <returns>The componentwise fractional part of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 frac(Fdouble2 x) { return x - floor(x); }

        /// <summary>Returns the componentwise fractional parts of a double3 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise fractional part of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 frac(Fdouble3 x) { return x - floor(x); }

        /// <summary>Returns the componentwise fractional parts of a double4 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise fractional part of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 frac(Fdouble4 x) { return x - floor(x); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 rcp(Ffloat2 x) { return 1.0f / x; }

        /// <summary>Returns the componentwise reciprocal a float3 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise reciprocal of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 rcp(Ffloat3 x) { return 1.0f / x; }

        /// <summary>Returns the componentwise reciprocal a float4 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise reciprocal of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 rcp(Ffloat4 x) { return 1.0f / x; }
        ...
        /// <returns>The componentwise reciprocal of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 rcp(Fdouble2 x) { return 1.0 / x; }

        /// <summary>Returns the componentwise reciprocal a double3 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise reciprocal of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 rcp(Fdouble3 x) { return 1.0 / x; }

        /// <summary>Returns the componentwise reciprocal a double4 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise reciprocal of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 rcp(Fdouble4 x) { return 1.0 / x; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 sign(Ffloat2 x) { return new Ffloat2(sign(x.x), sign(x.y)); }
        ...
        /// <returns>The componentwise sign of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 sign(Ffloat3 x) { return new Ffloat3(sign(x.x), sign(x.y), sign(x.z)); }
        ...
        /// <returns>The componentwise sign of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 sign(Ffloat4 x) { return new Ffloat4(sign(x.x), sign(x.y), sign(x.z), sign(x.w)); }
        ...
        /// <returns>The componentwise sign of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 sign(Fdouble2 x) { return new Fdouble2(sign(x.x), sign(x.y)); }
        ...
        /// <returns>The componentwise sign of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 sign(Fdouble3 x) { return new Fdouble3(sign(x.x), sign(x.y), sign(x.z)); }
        ...
        /// <returns>The componentwise sign of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 sign(Fdouble4 x) { return new Fdouble4(sign(x.x), sign(x.y), sign(x.z), sign(x.w)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 pow(Ffloat2 x, Ffloat2 y) { return new Ffloat2(pow(x.x, y.x), pow(x.y, y.y)); }
        ...
        /// <returns>The componentwise result of raising x to the power y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 pow(Ffloat3 x, Ffloat3 y) { return new Ffloat3(pow(x.x, y.x), pow(x.y, y.y), pow(x.z, y.z)); }
        ...
        /// <returns>The componentwise result of raising x to the power y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 pow(Ffloat4 x, Ffloat4 y) { return new Ffloat4(pow(x.x, y.x), pow(x.y, y.y), pow(x.z, y.z), pow(x.w, y.w)); }
        ...
        /// <returns>The componentwise result of raising x to the power y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 pow(Fdouble2 x, Fdouble2 y) { return new Fdouble2(pow(x.x, y.x), pow(x.y, y.y)); }
        ...
        /// <returns>The componentwise result of raising x to the power y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 pow(Fdouble3 x, Fdouble3 y) { return new Fdouble3(pow(x.x, y.x), pow(x.y, y.y), pow(x.z, y.z)); }
        ...
        /// <returns>The componentwise result of raising x to the power y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 pow(Fdouble4 x, Fdouble4 y) { return new Fdouble4(pow(x.x, y.x), pow(x.y, y.y), pow(x.z, y.z), pow(x.w, y.w)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 exp(Ffloat2 x) { return new Ffloat2(exp(x.x), exp(x.y)); }

        /// <summary>Returns the componentwise base-e exponential of x.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise base-e exponential of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 exp(Ffloat3 x) { return new Ffloat3(exp(x.x), exp(x.y), exp(x.z)); }

        /// <summary>Returns the componentwise base-e exponential of x.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise base-e exponential of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 exp(Ffloat4 x) { return new Ffloat4(exp(x.x), exp(x.y), exp(x.z), exp(x.w)); }
        ...
        /// <returns>The componentwise base-e exponential of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 exp(Fdouble2 x) { return new Fdouble2(exp(x.x), exp(x.y)); }

        /// <summary>Returns the componentwise base-e exponential of x.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise base-e exponential of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 exp(Fdouble3 x) { return new Fdouble3(exp(x.x), exp(x.y), exp(x.z)); }

        /// <summary>Returns the componentwise base-e exponential of x.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise base-e exponential of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 exp(Fdouble4 x) { return new Fdouble4(exp(x.x), exp(x.y), exp(x.z), exp(x.w)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 exp2(Ffloat2 x) { return new Ffloat2(exp2(x.x), exp2(x.y)); }

        /// <summary>Returns the componentwise base-2 exponential of x.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise base-2 exponential of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 exp2(Ffloat3 x) { return new Ffloat3(exp2(x.x), exp2(x.y), exp2(x.z)); }

        /// <summary>Returns the componentwise base-2 exponential of x.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise base-2 exponential of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 exp2(Ffloat4 x) { return new Ffloat4(exp2(x.x), exp2(x.y), exp2(x.z), exp2(x.w)); }
        ...
        /// <returns>The componentwise base-2 exponential of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 exp2(Fdouble2 x) { return new Fdouble2(exp2(x.x), exp2(x.y)); }

        /// <summary>Returns the componentwise base-2 exponential of x.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise base-2 exponential of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 exp2(Fdouble3 x) { return new Fdouble3(exp2(x.x), exp2(x.y), exp2(x.z)); }

        /// <summary>Returns the componentwise base-2 exponential of x.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise base-2 exponential of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 exp2(Fdouble4 x) { return new Fdouble4(exp2(x.x), exp2(x.y), exp2(x.z), exp2(x.w)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 exp10(Ffloat2 x) { return new Ffloat2(exp10(x.x), exp10(x.y)); }

        /// <summary>Returns the componentwise base-10 exponential of x.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise base-10 exponential of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 exp10(Ffloat3 x) { return new Ffloat3(exp10(x.x), exp10(x.y), exp10(x.z)); }

        /// <summary>Returns the componentwise base-10 exponential of x.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise base-10 exponential of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 exp10(Ffloat4 x) { return new Ffloat4(exp10(x.x), exp10(x.y), exp10(x.z), exp10(x.w)); }
        ...
        /// <returns>The componentwise base-10 exponential of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 exp10(Fdouble2 x) { return new Fdouble2(exp10(x.x), exp10(x.y)); }

        /// <summary>Returns the componentwise base-10 exponential of x.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise base-10 exponential of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 exp10(Fdouble3 x) { return new Fdouble3(exp10(x.x), exp10(x.y), exp10(x.z)); }

        /// <summary>Returns the componentwise base-10 exponential of x.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise base-10 exponential of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 exp10(Fdouble4 x) { return new Fdouble4(exp10(x.x), exp10(x.y), exp10(x.z), exp10(x.w)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 log(Ffloat2 x) { return new Ffloat2(log(x.x), log(x.y)); }

        /// <summary>Returns the componentwise natural logarithm of a float3 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise natural logarithm of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 log(Ffloat3 x) { return new Ffloat3(log(x.x), log(x.y), log(x.z)); }

        /// <summary>Returns the componentwise natural logarithm of a float4 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise natural logarithm of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 log(Ffloat4 x) { return new Ffloat4(log(x.x), log(x.y), log(x.z), log(x.w)); }
        ...
        /// <returns>The componentwise natural logarithm of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 log(Fdouble2 x) { return new Fdouble2(log(x.x), log(x.y)); }

        /// <summary>Returns the componentwise natural logarithm of a double3 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise natural logarithm of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 log(Fdouble3 x) { return new Fdouble3(log(x.x), log(x.y), log(x.z)); }

        /// <summary>Returns the componentwise natural logarithm of a double4 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise natural logarithm of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 log(Fdouble4 x) { return new Fdouble4(log(x.x), log(x.y), log(x.z), log(x.w)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 log2(Ffloat2 x) { return new Ffloat2(log2(x.x), log2(x.y)); }

        /// <summary>Returns the componentwise base-2 logarithm of a float3 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise base-2 logarithm of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 log2(Ffloat3 x) { return new Ffloat3(log2(x.x), log2(x.y), log2(x.z)); }

        /// <summary>Returns the componentwise base-2 logarithm of a float4 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise base-2 logarithm of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 log2(Ffloat4 x) { return new Ffloat4(log2(x.x), log2(x.y), log2(x.z), log2(x.w)); }
        ...
        /// <returns>The componentwise base-2 logarithm of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 log2(Fdouble2 x) { return new Fdouble2(log2(x.x), log2(x.y)); }

        /// <summary>Returns the componentwise base-2 logarithm of a double3 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise base-2 logarithm of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 log2(Fdouble3 x) { return new Fdouble3(log2(x.x), log2(x.y), log2(x.z)); }

        /// <summary>Returns the componentwise base-2 logarithm of a double4 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise base-2 logarithm of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 log2(Fdouble4 x) { return new Fdouble4(log2(x.x), log2(x.y), log2(x.z), log2(x.w)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 log10(Ffloat2 x) { return new Ffloat2(log10(x.x), log10(x.y)); }

        /// <summary>Returns the componentwise base-10 logarithm of a float3 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise base-10 logarithm of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 log10(Ffloat3 x) { return new Ffloat3(log10(x.x), log10(x.y), log10(x.z)); }

        /// <summary>Returns the componentwise base-10 logarithm of a float4 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise base-10 logarithm of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 log10(Ffloat4 x) { return new Ffloat4(log10(x.x), log10(x.y), log10(x.z), log10(x.w)); }
        ...
        /// <returns>The componentwise base-10 logarithm of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 log10(Fdouble2 x) { return new Fdouble2(log10(x.x), log10(x.y)); }

        /// <summary>Returns the componentwise base-10 logarithm of a double3 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise base-10 logarithm of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 log10(Fdouble3 x) { return new Fdouble3(log10(x.x), log10(x.y), log10(x.z)); }

        /// <summary>Returns the componentwise base-10 logarithm of a double4 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise base-10 logarithm of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 log10(Fdouble4 x) { return new Fdouble4(log10(x.x), log10(x.y), log10(x.z), log10(x.w)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 fmod(Ffloat2 x, Ffloat2 y) { return new Ffloat2(x.x % y.x, x.y % y.y); }
        ...
        /// <returns>The componentwise remainder of x/y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 fmod(Ffloat3 x, Ffloat3 y) { return new Ffloat3(x.x % y.x, x.y % y.y, x.z % y.z); }
        ...
        /// <returns>The componentwise remainder of x/y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 fmod(Ffloat4 x, Ffloat4 y) { return new Ffloat4(x.x % y.x, x.y % y.y, x.z % y.z, x.w % y.w); }
        ...
        /// <returns>The componentwise remainder of x/y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 fmod(Fdouble2 x, Fdouble2 y) { return new Fdouble2(x.x % y.x, x.y % y.y); }
        ...
        /// <returns>The componentwise remainder of x/y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 fmod(Fdouble3 x, Fdouble3 y) { return new Fdouble3(x.x % y.x, x.y % y.y, x.z % y.z); }
        ...
        /// <returns>The componentwise remainder of x/y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 fmod(Fdouble4 x, Fdouble4 y) { return new Fdouble4(x.x % y.x, x.y % y.y, x.z % y.z, x.w % y.w); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 modf(Ffloat2 x, out Ffloat2 i) { i = trunc(x); return x - i; }
        ...
        /// <returns>The componentwise fractional part of x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 modf(Ffloat3 x, out Ffloat3 i) { i = trunc(x); return x - i; }
        ...
        /// <returns>The componentwise fractional part of x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 modf(Ffloat4 x, out Ffloat4 i) { i = trunc(x); return x - i; }
        ...
        /// <returns>The componentwise fractional part of x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 modf(Fdouble2 x, out Fdouble2 i) { i = trunc(x); return x - i; }
        ...
        /// <returns>The componentwise fractional part of x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 modf(Fdouble3 x, out Fdouble3 i) { i = trunc(x); return x - i; }
        ...
        /// <returns>The componentwise fractional part of x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 modf(Fdouble4 x, out Fdouble4 i) { i = trunc(x); return x - i; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 sqrt(Ffloat2 x) { return new Ffloat2(sqrt(x.x), sqrt(x.y)); }

        /// <summary>Returns the componentwise square root of a float3 vector.</summary>
        /// <param name="x">Value to use when computing square root.</param>
        /// <returns>The componentwise square root.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 sqrt(Ffloat3 x) { return new Ffloat3(sqrt(x.x), sqrt(x.y), sqrt(x.z)); }

        /// <summary>Returns the componentwise square root of a float4 vector.</summary>
        /// <param name="x">Value to use when computing square root.</param>
        /// <returns>The componentwise square root.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 sqrt(Ffloat4 x) { return new Ffloat4(sqrt(x.x), sqrt(x.y), sqrt(x.z), sqrt(x.w)); }
        ...
        /// <returns>The componentwise square root.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 sqrt(Fdouble2 x) { return new Fdouble2(sqrt(x.x), sqrt(x.y)); }

        /// <summary>Returns the componentwise square root of a double3 vector.</summary>
        /// <param name="x">Value to use when computing square root.</param>
        /// <returns>The componentwise square root.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 sqrt(Fdouble3 x) { return new Fdouble3(sqrt(x.x), sqrt(x.y), sqrt(x.z)); }

        /// <summary>Returns the componentwise square root of a double4 vector.</summary>
        /// <param name="x">Value to use when computing square root.</param>
        /// <returns>The componentwise square root.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 sqrt(Fdouble4 x) { return new Fdouble4(sqrt(x.x), sqrt(x.y), sqrt(x.z), sqrt(x.w)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 rsqrt(Ffloat2 x) { return 1.0f / sqrt(x); }

        /// <summary>Returns the componentwise reciprocal square root of a float3 vector.</summary>
        /// <param name="x">Value to use when computing reciprocal square root.</param>
        /// <returns>The componentwise reciprocal square root.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 rsqrt(Ffloat3 x) { return 1.0f / sqrt(x); }

        /// <summary>Returns the componentwise reciprocal square root of a float4 vector</summary>
        /// <param name="x">Value to use when computing reciprocal square root.</param>
        /// <returns>The componentwise reciprocal square root.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 rsqrt(Ffloat4 x) { return 1.0f / sqrt(x); }
        ...
        /// <returns>The componentwise reciprocal square root.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 rsqrt(Fdouble2 x) { return 1.0 / sqrt(x); }

        /// <summary>Returns the componentwise reciprocal square root of a double3 vector.</summary>
        /// <param name="x">Value to use when computing reciprocal square root.</param>
        /// <returns>The componentwise reciprocal square root.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 rsqrt(Fdouble3 x) { return 1.0 / sqrt(x); }

        /// <summary>Returns the componentwise reciprocal square root of a double4 vector.</summary>
        /// <param name="x">Value to use when computing reciprocal square root.</param>
        /// <returns>The componentwise reciprocal square root.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 rsqrt(Fdouble4 x) { return 1.0 / sqrt(x); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 normalize(Ffloat2 x) { return rsqrt(dot(x, x)) * x; }

        /// <summary>Returns a normalized version of the float3 vector x by scaling it by 1 / length(x).</summary>
        /// <param name="x">Vector to normalize.</param>
        /// <returns>The normalized vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 normalize(Ffloat3 x) { return rsqrt(dot(x, x)) * x; }

        /// <summary>Returns a normalized version of the float4 vector x by scaling it by 1 / length(x).</summary>
        /// <param name="x">Vector to normalize.</param>
        /// <returns>The normalized vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 normalize(Ffloat4 x) { return rsqrt(dot(x, x)) * x; }
        ...
        /// <returns>The normalized vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 normalize(Fdouble2 x) { return rsqrt(dot(x, x)) * x; }

        /// <summary>Returns a normalized version of the double3 vector x by scaling it by 1 / length(x).</summary>
        /// <param name="x">Vector to normalize.</param>
        /// <returns>The normalized vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 normalize(Fdouble3 x) { return rsqrt(dot(x, x)) * x; }

        /// <summary>Returns a normalized version of the double4 vector x by scaling it by 1 / length(x).</summary>
        /// <param name="x">Vector to normalize.</param>
        /// <returns>The normalized vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 normalize(Fdouble4 x) { return rsqrt(dot(x, x)) * x; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public Ffloat2 normalizesafe(Ffloat2 x, Ffloat2 defaultvalue = new Ffloat2())
        {
            float len = Fmath.dot(x, x);
            return Fmath.select(defaultvalue, x * Fmath.rsqrt(len), len > FLT_MIN_NORMAL);
        }
        ...
        /// <returns>The normalized vector or the default value if the normalized vector is not finite.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public Ffloat3 normalizesafe(Ffloat3 x, Ffloat3 defaultvalue = new Ffloat3())
        {
            float len = Fmath.dot(x, x);
            return Fmath.select(defaultvalue, x * Fmath.rsqrt(len), len > FLT_MIN_NORMAL);
        }
        ...
        /// <returns>The normalized vector or the default value if the normalized vector is not finite.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public Ffloat4 normalizesafe(Ffloat4 x, Ffloat4 defaultvalue = new Ffloat4())
        {
            float len = Fmath.dot(x, x);
            return Fmath.select(defaultvalue, x * Fmath.rsqrt(len), len > FLT_MIN_NORMAL);
        }
        ...
        /// <returns>The normalized vector or the default value if the normalized vector is not finite.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public Fdouble2 normalizesafe(Fdouble2 x, Fdouble2 defaultvalue = new Fdouble2())
        {
            double len = Fmath.dot(x, x);
            return Fmath.select(defaultvalue, x * Fmath.rsqrt(len), len > FLT_MIN_NORMAL);
        }
        ...
        /// <returns>The normalized vector or the default value if the normalized vector is not finite.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public Fdouble3 normalizesafe(Fdouble3 x, Fdouble3 defaultvalue = new Fdouble3())
        {
            double len = Fmath.dot(x, x);
            return Fmath.select(defaultvalue, x * Fmath.rsqrt(len), len > FLT_MIN_NORMAL);
        }
        ...
        /// <returns>The normalized vector or the default value if the normalized vector is not finite.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public Fdouble4 normalizesafe(Fdouble4 x, Fdouble4 defaultvalue = new Fdouble4())
        {
            double len = Fmath.dot(x, x);
            return Fmath.select(defaultvalue, x * Fmath.rsqrt(len), len > FLT_MIN_NORMAL);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float length(Ffloat2 x) { return sqrt(dot(x, x)); }

        /// <summary>Returns the length of a float3 vector.</summary>
        /// <param name="x">Vector to use when computing length.</param>
        /// <returns>Length of vector x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float length(Ffloat3 x) { return sqrt(dot(x, x)); }

        /// <summary>Returns the length of a float4 vector.</summary>
        /// <param name="x">Vector to use when computing length.</param>
        /// <returns>Length of vector x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float length(Ffloat4 x) { return sqrt(dot(x, x)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double length(Fdouble2 x) { return sqrt(dot(x, x)); }

        /// <summary>Returns the length of a double3 vector.</summary>
        /// <param name="x">Vector to use when computing squared length.</param>
        /// <returns>Squared length of vector x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double length(Fdouble3 x) { return sqrt(dot(x, x)); }

        /// <summary>Returns the length of a double4 vector.</summary>
        /// <param name="x">Vector to use when computing squared length.</param>
        /// <returns>Squared length of vector x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double length(Fdouble4 x) { return sqrt(dot(x, x)); }
        ...
        /// <returns>Squared length of vector x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float lengthsq(Ffloat2 x) { return dot(x, x); }

        /// <summary>Returns the squared length of a float3 vector.</summary>
        /// <param name="x">Vector to use when computing squared length.</param>
        /// <returns>Squared length of vector x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float lengthsq(Ffloat3 x) { return dot(x, x); }

        /// <summary>Returns the squared length of a float4 vector.</summary>
        /// <param name="x">Vector to use when computing squared length.</param>
        /// <returns>Squared length of vector x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float lengthsq(Ffloat4 x) { return dot(x, x); }
        ...
        /// <returns>Squared length of vector x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double lengthsq(Fdouble2 x) { return dot(x, x); }

        /// <summary>Returns the squared length of a double3 vector.</summary>
        /// <param name="x">Vector to use when computing squared length.</param>
        /// <returns>Squared length of vector x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double lengthsq(Fdouble3 x) { return dot(x, x); }

        /// <summary>Returns the squared length of a double4 vector.</summary>
        /// <param name="x">Vector to use when computing squared length.</param>
        /// <returns>Squared length of vector x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double lengthsq(Fdouble4 x) { return dot(x, x); }
        ...
        /// <returns>The distance between x and y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float distance(Ffloat2 x, Ffloat2 y) { return length(y - x); }
        ...
        /// <returns>The distance between x and y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float distance(Ffloat3 x, Ffloat3 y) { return length(y - x); }
        ...
        /// <returns>The distance between x and y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float distance(Ffloat4 x, Ffloat4 y) { return length(y - x); }
        ...
        /// <returns>The distance between x and y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double distance(Fdouble2 x, Fdouble2 y) { return length(y - x); }
        ...
        /// <returns>The distance between x and y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double distance(Fdouble3 x, Fdouble3 y) { return length(y - x); }
        ...
        /// <returns>The distance between x and y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double distance(Fdouble4 x, Fdouble4 y) { return length(y - x); }
        ...
        /// <returns>The squared distance between x and y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float distancesq(Ffloat2 x, Ffloat2 y) { return lengthsq(y - x); }
        ...
        /// <returns>The squared distance between x and y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float distancesq(Ffloat3 x, Ffloat3 y) { return lengthsq(y - x); }
        ...
        /// <returns>The squared distance between x and y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float distancesq(Ffloat4 x, Ffloat4 y) { return lengthsq(y - x); }
        ...
        /// <returns>The squared distance between x and y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double distancesq(Fdouble2 x, Fdouble2 y) { return lengthsq(y - x); }
        ...
        /// <returns>The squared distance between x and y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double distancesq(Fdouble3 x, Fdouble3 y) { return lengthsq(y - x); }
        ...
        /// <returns>The squared distance between x and y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double distancesq(Fdouble4 x, Fdouble4 y) { return lengthsq(y - x); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 cross(Ffloat3 x, Ffloat3 y) { return (x * y.yzx - x.yzx * y).yzx; }
        ...
        /// <returns>The cross product of x and y.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 cross(Fdouble3 x, Fdouble3 y) { return (x * y.yzx - x.yzx * y).yzx; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 smoothstep(Ffloat2 a, Ffloat2 b, Ffloat2 x)
        {
            var t = saturate((x - a) / (b - a));
            return t * t * (3.0f - (2.0f * t));
        }
        ...
        /// <returns>Returns component values camped to the range [0, 1].</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 smoothstep(Ffloat3 a, Ffloat3 b, Ffloat3 x)
        {
            var t = saturate((x - a) / (b - a));
            return t * t * (3.0f - (2.0f * t));
        }
        ...
        /// <returns>Returns component values camped to the range [0, 1].</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 smoothstep(Ffloat4 a, Ffloat4 b, Ffloat4 x)
        {
            var t = saturate((x - a) / (b - a));
            return t * t * (3.0f - (2.0f * t));
        }
        ...
        /// <returns>Returns component values camped to the range [0, 1].</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 smoothstep(Fdouble2 a, Fdouble2 b, Fdouble2 x)
        {
            var t = saturate((x - a) / (b - a));
            return t * t * (3.0 - (2.0 * t));
        }
        ...
        /// <returns>Returns component values camped to the range [0, 1].</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 smoothstep(Fdouble3 a, Fdouble3 b, Fdouble3 x)
        {
            var t = saturate((x - a) / (b - a));
            return t * t * (3.0 - (2.0 * t));
        }
        ...
        /// <returns>Returns component values camped to the range [0, 1].</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 smoothstep(Fdouble4 a, Fdouble4 b, Fdouble4 x)
        {
            var t = saturate((x - a) / (b - a));
            return t * t * (3.0 - (2.0 * t));
        }
        ...
        /// <returns>The selection between a and b according to bool c.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2 select(Fint2 a, Fint2 b, bool c) { return c ? b : a; }
        ...
        /// <returns>The selection between a and b according to bool c.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint3 select(Fint3 a, Fint3 b, bool c) { return c ? b : a; }
        ...
        /// <returns>The selection between a and b according to bool c.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint4 select(Fint4 a, Fint4 b, bool c) { return c ? b : a; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2 select(Fint2 a, Fint2 b, Fbool2 c) { return new Fint2(c.x ? b.x : a.x, c.y ? b.y : a.y); }
        ...
        /// <returns>The componentwise selection between a and b according to selection mask c.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint3 select(Fint3 a, Fint3 b, Fbool3 c) { return new Fint3(c.x ? b.x : a.x, c.y ? b.y : a.y, c.z ? b.z : a.z); }
        ...
        /// <returns>The componentwise selection between a and b according to selection mask c.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint4 select(Fint4 a, Fint4 b, Fbool4 c) { return new Fint4(c.x ? b.x : a.x, c.y ? b.y : a.y, c.z ? b.z : a.z, c.w ? b.w : a.w); }
        ...
        /// <returns>The selection between a and b according to bool c.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint2 select(Fuint2 a, Fuint2 b, bool c) { return c ? b : a; }
        ...
        /// <returns>The selection between a and b according to bool c.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint3 select(Fuint3 a, Fuint3 b, bool c) { return c ? b : a; }
        ...
        /// <returns>The selection between a and b according to bool c.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint4 select(Fuint4 a, Fuint4 b, bool c) { return c ? b : a; }
        ...
        /// <returns>The componentwise selection between a and b according to selection mask c.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint2 select(Fuint2 a, Fuint2 b, Fbool2 c) { return new Fuint2(c.x ? b.x : a.x, c.y ? b.y : a.y); }
        ...
        /// <returns>The componentwise selection between a and b according to selection mask c.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint3 select(Fuint3 a, Fuint3 b, Fbool3 c) { return new Fuint3(c.x ? b.x : a.x, c.y ? b.y : a.y, c.z ? b.z : a.z); }
        ...
        /// <returns>The componentwise selection between a and b according to selection mask c.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint4 select(Fuint4 a, Fuint4 b, Fbool4 c) { return new Fuint4(c.x ? b.x : a.x, c.y ? b.y : a.y, c.z ? b.z : a.z, c.w ? b.w : a.w); }
        ...
        /// <returns>The selection between a and b according to bool c.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 select(Ffloat2 a, Ffloat2 b, bool c) { return c ? b : a; }
        ...
        /// <returns>The selection between a and b according to bool c.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 select(Ffloat3 a, Ffloat3 b, bool c) { return c ? b : a; }
        ...
        /// <returns>The selection between a and b according to bool c.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 select(Ffloat4 a, Ffloat4 b, bool c) { return c ? b : a; }
        ...
        /// <returns>The componentwise selection between a and b according to selection mask c.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 select(Ffloat2 a, Ffloat2 b, Fbool2 c) { return new Ffloat2(c.x ? b.x : a.x, c.y ? b.y : a.y); }
        ...
        /// <returns>The componentwise selection between a and b according to selection mask c.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 select(Ffloat3 a, Ffloat3 b, Fbool3 c) { return new Ffloat3(c.x ? b.x : a.x, c.y ? b.y : a.y, c.z ? b.z : a.z); }
        ...
        /// <returns>The componentwise selection between a and b according to selection mask c.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 select(Ffloat4 a, Ffloat4 b, Fbool4 c) { return new Ffloat4(c.x ? b.x : a.x, c.y ? b.y : a.y, c.z ? b.z : a.z, c.w ? b.w : a.w); }
        ...
        /// <returns>The selection between a and b according to bool c.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 select(Fdouble2 a, Fdouble2 b, bool c) { return c ? b : a; }
        ...
        /// <returns>The selection between a and b according to bool c.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 select(Fdouble3 a, Fdouble3 b, bool c) { return c ? b : a; }
        ...
        /// <returns>The selection between a and b according to bool c.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 select(Fdouble4 a, Fdouble4 b, bool c) { return c ? b : a; }
        ...
        /// <returns>The componentwise selection between a and b according to selection mask c.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 select(Fdouble2 a, Fdouble2 b, Fbool2 c) { return new Fdouble2(c.x ? b.x : a.x, c.y ? b.y : a.y); }
        ...
        /// <returns>The componentwise selection between a and b according to selection mask c.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 select(Fdouble3 a, Fdouble3 b, Fbool3 c) { return new Fdouble3(c.x ? b.x : a.x, c.y ? b.y : a.y, c.z ? b.z : a.z); }
        ...
        /// <returns>The componentwise selection between a and b according to selection mask c.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 select(Fdouble4 a, Fdouble4 b, Fbool4 c) { return new Fdouble4(c.x ? b.x : a.x, c.y ? b.y : a.y, c.z ? b.z : a.z, c.w ? b.w : a.w); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 step(Ffloat2 y, Ffloat2 x) { return select(float2(0.0f), float2(1.0f), x >= y); }
        ...
        /// <returns>1 if the componentwise comparison x &gt;= y is true, otherwise 0.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 step(Ffloat3 y, Ffloat3 x) { return select(float3(0.0f), float3(1.0f), x >= y); }
        ...
        /// <returns>1 if the componentwise comparison x &gt;= y is true, otherwise 0.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 step(Ffloat4 y, Ffloat4 x) { return select(float4(0.0f), float4(1.0f), x >= y); }
        ...
        /// <returns>1 if the componentwise comparison x &gt;= y is true, otherwise 0.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 step(Fdouble2 y, Fdouble2 x) { return select(double2(0.0), double2(1.0), x >= y); }
        ...
        /// <returns>1 if the componentwise comparison x &gt;= y is true, otherwise 0.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 step(Fdouble3 y, Fdouble3 x) { return select(double3(0.0), double3(1.0), x >= y); }
        ...
        /// <returns>1 if the componentwise comparison x &gt;= y is true, otherwise 0.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 step(Fdouble4 y, Fdouble4 x) { return select(double4(0.0), double4(1.0), x >= y); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 reflect(Ffloat2 i, Ffloat2 n) { return i - 2f * n * dot(i, n); }
        ...
        /// <returns>Reflection vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 reflect(Ffloat3 i, Ffloat3 n) { return i - 2f * n * dot(i, n); }
        ...
        /// <returns>Reflection vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 reflect(Ffloat4 i, Ffloat4 n) { return i - 2f * n * dot(i, n); }
        ...
        /// <returns>Reflection vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 reflect(Fdouble2 i, Fdouble2 n) { return i - 2 * n * dot(i, n); }
        ...
        /// <returns>Reflection vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 reflect(Fdouble3 i, Fdouble3 n) { return i - 2 * n * dot(i, n); }
        ...
        /// <returns>Reflection vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 reflect(Fdouble4 i, Fdouble4 n) { return i - 2 * n * dot(i, n); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 refract(Ffloat2 i, Ffloat2 n, float eta)
        {
            float ni = dot(n, i);
        ...
        /// <returns>Refraction vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 refract(Ffloat3 i, Ffloat3 n, float eta)
        {
            float ni = dot(n, i);
            float k = 1.0f - eta * eta * (1.0f - ni * ni);
            return select(0.0f, eta * i - (eta * ni + sqrt(k)) * n, k >= 0);
        ...
        /// <returns>Refraction vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 refract(Ffloat4 i, Ffloat4 n, float eta)
        {
            float ni = dot(n, i);
            float k = 1.0f - eta * eta * (1.0f - ni * ni);
            return select(0.0f, eta * i - (eta * ni + sqrt(k)) * n, k >= 0);
        ...
        /// <returns>Refraction vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 refract(Fdouble2 i, Fdouble2 n, double eta)
        {
            double ni = dot(n, i);
        ...
        /// <returns>Refraction vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 refract(Fdouble3 i, Fdouble3 n, double eta)
        {
            double ni = dot(n, i);
            double k = 1.0 - eta * eta * (1.0 - ni * ni);
            return select(0.0f, eta * i - (eta * ni + sqrt(k)) * n, k >= 0);
        ...
        /// <returns>Refraction vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 refract(Fdouble4 i, Fdouble4 n, double eta)
        {
            double ni = dot(n, i);
            double k = 1.0 - eta * eta * (1.0 - ni * ni);
            return select(0.0f, eta * i - (eta * ni + sqrt(k)) * n, k >= 0);
        ...
        /// In these cases, you can call <see cref="projectsafe(Fraktalia.Core.Mathematics.Ffloat2,Fraktalia.Core.Mathematics.Ffloat2,Fraktalia.Core.Mathematics.Ffloat2)"/>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 project(Ffloat2 a, Ffloat2 b)
        {
        ...
        /// Some finite vectors a and b could generate a non-finite result. This is most likely when a's components
        /// are very large (close to Single.MaxValue) or when b's components are very small (close to FLT_MIN_NORMAL).
        /// In these cases, you can call <see cref="projectsafe(Fraktalia.Core.Mathematics.Ffloat3,Fraktalia.Core.Mathematics.Ffloat3,Fraktalia.Core.Mathematics.Ffloat3)"/>
        /// which will use a given default value if the result is not finite.
        /// </remarks>
        /// <param name="a">Vector to project.</param>
        /// <param name="b">Non-zero vector to project onto.</param>
        /// <returns>Vector projection of a onto b.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 project(Ffloat3 a, Ffloat3 b)
        {
            return (dot(a, b) / dot(b, b)) * b;
        }
        ...
        /// Some finite vectors a and b could generate a non-finite result. This is most likely when a's components
        /// are very large (close to Single.MaxValue) or when b's components are very small (close to FLT_MIN_NORMAL).
        /// In these cases, you can call <see cref="projectsafe(Fraktalia.Core.Mathematics.Ffloat4,Fraktalia.Core.Mathematics.Ffloat4,Fraktalia.Core.Mathematics.Ffloat4)"/>
        /// which will use a given default value if the result is not finite.
        /// </remarks>
        /// <param name="a">Vector to project.</param>
        /// <param name="b">Non-zero vector to project onto.</param>
        /// <returns>Vector projection of a onto b.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 project(Ffloat4 a, Ffloat4 b)
        {
            return (dot(a, b) / dot(b, b)) * b;
        }
        ...
        /// <see cref="project(Fraktalia.Core.Mathematics.Ffloat2,Fraktalia.Core.Mathematics.Ffloat2)"/> instead which is faster than this
        /// function.
        /// </remarks>
        /// <param name="a">Vector to project.</param>
        /// <param name="b">Non-zero vector to project onto.</param>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 projectsafe(Ffloat2 a, Ffloat2 b, Ffloat2 defaultValue = new Ffloat2())
        {
        ...
        /// This function performs extra checks to see if the result of projecting a onto b is finite. If you know that
        /// your inputs will generate a finite result or you don't care if the result is finite, then you can call
        /// <see cref="project(Fraktalia.Core.Mathematics.Ffloat3,Fraktalia.Core.Mathematics.Ffloat3)"/> instead which is faster than this
        /// function.
        /// </remarks>
        /// <param name="a">Vector to project.</param>
        /// <param name="b">Non-zero vector to project onto.</param>
        ...
        /// <returns>Vector projection of a onto b or the default value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 projectsafe(Ffloat3 a, Ffloat3 b, Ffloat3 defaultValue = new Ffloat3())
        {
            var proj = project(a, b);
        ...
        /// This function performs extra checks to see if the result of projecting a onto b is finite. If you know that
        /// your inputs will generate a finite result or you don't care if the result is finite, then you can call
        /// <see cref="project(Fraktalia.Core.Mathematics.Ffloat4,Fraktalia.Core.Mathematics.Ffloat4)"/> instead which is faster than this
        /// function.
        /// </remarks>
        /// <param name="a">Vector to project.</param>
        /// <param name="b">Non-zero vector to project onto.</param>
        ...
        /// <returns>Vector projection of a onto b or the default value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 projectsafe(Ffloat4 a, Ffloat4 b, Ffloat4 defaultValue = new Ffloat4())
        {
            var proj = project(a, b);
        ...
        /// In these cases, you can call <see cref="projectsafe(Fraktalia.Core.Mathematics.Fdouble2,Fraktalia.Core.Mathematics.Fdouble2,Fraktalia.Core.Mathematics.Fdouble2)"/>
        /// which will use a given default value if the result is not finite.
        /// </remarks>
        /// <param name="a">Vector to project.</param>
        /// <param name="b">Non-zero vector to project onto.</param>
        /// <returns>Vector projection of a onto b.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 project(Fdouble2 a, Fdouble2 b)
        {
            return (dot(a, b) / dot(b, b)) * b;
        }
        ...
        /// Some finite vectors a and b could generate a non-finite result. This is most likely when a's components
        /// are very large (close to Double.MaxValue) or when b's components are very small (close to DBL_MIN_NORMAL).
        /// In these cases, you can call <see cref="projectsafe(Fraktalia.Core.Mathematics.Fdouble3,Fraktalia.Core.Mathematics.Fdouble3,Fraktalia.Core.Mathematics.Fdouble3)"/>
        /// which will use a given default value if the result is not finite.
        /// </remarks>
        /// <param name="a">Vector to project.</param>
        /// <param name="b">Non-zero vector to project onto.</param>
        /// <returns>Vector projection of a onto b.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 project(Fdouble3 a, Fdouble3 b)
        {
            return (dot(a, b) / dot(b, b)) * b;
        }
        ...
        /// Some finite vectors a and b could generate a non-finite result. This is most likely when a's components
        /// are very large (close to Double.MaxValue) or when b's components are very small (close to DBL_MIN_NORMAL).
        /// In these cases, you can call <see cref="projectsafe(Fraktalia.Core.Mathematics.Fdouble4,Fraktalia.Core.Mathematics.Fdouble4,Fraktalia.Core.Mathematics.Fdouble4)"/>
        /// which will use a given default value if the result is not finite.
        /// </remarks>
        /// <param name="a">Vector to project.</param>
        /// <param name="b">Non-zero vector to project onto.</param>
        /// <returns>Vector projection of a onto b.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 project(Fdouble4 a, Fdouble4 b)
        {
            return (dot(a, b) / dot(b, b)) * b;
        }
        ...
        /// This function performs extra checks to see if the result of projecting a onto b is finite. If you know that
        /// your inputs will generate a finite result or you don't care if the result is finite, then you can call
        /// <see cref="project(Fraktalia.Core.Mathematics.Fdouble2,Fraktalia.Core.Mathematics.Fdouble2)"/> instead which is faster than this
        /// function.
        /// </remarks>
        /// <param name="a">Vector to project.</param>
        /// <param name="b">Non-zero vector to project onto.</param>
        ...
        /// <returns>Vector projection of a onto b or the default value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 projectsafe(Fdouble2 a, Fdouble2 b, Fdouble2 defaultValue = new Fdouble2())
        {
            var proj = project(a, b);
        ...
        /// This function performs extra checks to see if the result of projecting a onto b is finite. If you know that
        /// your inputs will generate a finite result or you don't care if the result is finite, then you can call
        /// <see cref="project(Fraktalia.Core.Mathematics.Fdouble3,Fraktalia.Core.Mathematics.Fdouble3)"/> instead which is faster than this
        /// function.
        /// </remarks>
        /// <param name="a">Vector to project.</param>
        /// <param name="b">Non-zero vector to project onto.</param>
        ...
        /// <returns>Vector projection of a onto b or the default value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 projectsafe(Fdouble3 a, Fdouble3 b, Fdouble3 defaultValue = new Fdouble3())
        {
            var proj = project(a, b);
        ...
        /// This function performs extra checks to see if the result of projecting a onto b is finite. If you know that
        /// your inputs will generate a finite result or you don't care if the result is finite, then you can call
        /// <see cref="project(Fraktalia.Core.Mathematics.Fdouble4,Fraktalia.Core.Mathematics.Fdouble4)"/> instead which is faster than this
        /// function.
        /// </remarks>
        /// <param name="a">Vector to project.</param>
        /// <param name="b">Non-zero vector to project onto.</param>
        ...
        /// <returns>Vector projection of a onto b or the default value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 projectsafe(Fdouble4 a, Fdouble4 b, Fdouble4 defaultValue = new Fdouble4())
        {
            var proj = project(a, b);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 faceforward(Ffloat2 n, Ffloat2 i, Ffloat2 ng) { return select(n, -n, dot(ng, i) >= 0.0f); }
        ...
        /// <returns>-n if i and ng point in the same direction; otherwise return n unchanged.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 faceforward(Ffloat3 n, Ffloat3 i, Ffloat3 ng) { return select(n, -n, dot(ng, i) >= 0.0f); }
        ...
        /// <returns>-n if i and ng point in the same direction; otherwise return n unchanged.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 faceforward(Ffloat4 n, Ffloat4 i, Ffloat4 ng) { return select(n, -n, dot(ng, i) >= 0.0f); }
        ...
        /// <returns>-n if i and ng point in the same direction; otherwise return n unchanged.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 faceforward(Fdouble2 n, Fdouble2 i, Fdouble2 ng) { return select(n, -n, dot(ng, i) >= 0.0f); }
        ...
        /// <returns>-n if i and ng point in the same direction; otherwise return n unchanged.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 faceforward(Fdouble3 n, Fdouble3 i, Fdouble3 ng) { return select(n, -n, dot(ng, i) >= 0.0f); }
        ...
        /// <returns>-n if i and ng point in the same direction; otherwise return n unchanged.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 faceforward(Fdouble4 n, Fdouble4 i, Fdouble4 ng) { return select(n, -n, dot(ng, i) >= 0.0f); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void sincos(Ffloat2 x, out Ffloat2 s, out Ffloat2 c) { s = sin(x); c = cos(x); }
        ...
        /// <param name="c">Output vector containing the componentwise cosine of the input.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void sincos(Ffloat3 x, out Ffloat3 s, out Ffloat3 c) { s = sin(x); c = cos(x); }
        ...
        /// <param name="c">Output vector containing the componentwise cosine of the input.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void sincos(Ffloat4 x, out Ffloat4 s, out Ffloat4 c) { s = sin(x); c = cos(x); }
        ...
        /// <param name="c">Output vector containing the componentwise cosine of the input.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void sincos(Fdouble2 x, out Fdouble2 s, out Fdouble2 c) { s = sin(x); c = cos(x); }
        ...
        /// <param name="c">Output vector containing the componentwise cosine of the input.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void sincos(Fdouble3 x, out Fdouble3 s, out Fdouble3 c) { s = sin(x); c = cos(x); }
        ...
        /// <param name="c">Output vector containing the componentwise cosine of the input.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void sincos(Fdouble4 x, out Fdouble4 s, out Fdouble4 c) { s = sin(x); c = cos(x); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2 countbits(Fint2 x) { return countbits((Fuint2)x); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint3 countbits(Fint3 x) { return countbits((Fuint3)x); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint4 countbits(Fint4 x) { return countbits((Fuint4)x); }
        ...
        /// <returns>int2 containing number of bits set to 1 within each component of x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2 countbits(Fuint2 x)
        {
            x = x - ((x >> 1) & 0x55555555);
            x = (x & 0x33333333) + ((x >> 2) & 0x33333333);
        ...
        /// <returns>int3 containing number of bits set to 1 within each component of x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint3 countbits(Fuint3 x)
        {
            x = x - ((x >> 1) & 0x55555555);
            x = (x & 0x33333333) + ((x >> 2) & 0x33333333);
        ...
        /// <returns>int4 containing number of bits set to 1 within each component of x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint4 countbits(Fuint4 x)
        {
            x = x - ((x >> 1) & 0x55555555);
            x = (x & 0x33333333) + ((x >> 2) & 0x33333333);
        ...
        /// <returns>The componentwise number of leading zeros of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2 lzcnt(Fuint2 x) { return int2(lzcnt(x.x), lzcnt(x.y)); }

        /// <summary>Returns the componentwise number of leading zeros in the binary representations of a uint3 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise number of leading zeros of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint3 lzcnt(Fuint3 x) { return int3(lzcnt(x.x), lzcnt(x.y), lzcnt(x.z)); }

        /// <summary>Returns the componentwise number of leading zeros in the binary representations of a uint4 vector.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The componentwise number of leading zeros of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint4 lzcnt(Fuint4 x) { return int4(lzcnt(x.x), lzcnt(x.y), lzcnt(x.z), lzcnt(x.w)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2 tzcnt(Fint2 x) { return int2(tzcnt(x.x), tzcnt(x.y)); }
        ...
        /// <returns>Returns the component-wise trailing zero count of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint3 tzcnt(Fint3 x) { return int3(tzcnt(x.x), tzcnt(x.y), tzcnt(x.z)); }
        ...
        /// <returns>Returns the component-wise trailing zero count of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint4 tzcnt(Fint4 x) { return int4(tzcnt(x.x), tzcnt(x.y), tzcnt(x.z), tzcnt(x.w)); }
        ...
        /// <returns>Returns the component-wise trailing zero count of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2 tzcnt(Fuint2 x) { return int2(tzcnt(x.x), tzcnt(x.y)); }
        ...
        /// <returns>Returns the component-wise trailing zero count of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint3 tzcnt(Fuint3 x) { return int3(tzcnt(x.x), tzcnt(x.y), tzcnt(x.z)); }
        ...
        /// <returns>Returns the component-wise trailing zero count of the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint4 tzcnt(Fuint4 x) { return int4(tzcnt(x.x), tzcnt(x.y), tzcnt(x.z), tzcnt(x.w)); }
        ...
        /// <returns>Value with componentwise reversed bits.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint2 reversebits(Fuint2 x)
        {
            x = ((x >> 1) & 0x55555555) | ((x & 0x55555555) << 1);
            x = ((x >> 2) & 0x33333333) | ((x & 0x33333333) << 2);
            x = ((x >> 4) & 0x0F0F0F0F) | ((x & 0x0F0F0F0F) << 4);
        ...
        /// <returns>Value with componentwise reversed bits.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint3 reversebits(Fuint3 x)
        {
            x = ((x >> 1) & 0x55555555) | ((x & 0x55555555) << 1);
            x = ((x >> 2) & 0x33333333) | ((x & 0x33333333) << 2);
            x = ((x >> 4) & 0x0F0F0F0F) | ((x & 0x0F0F0F0F) << 4);
        ...
        /// <returns>Value with componentwise reversed bits.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint4 reversebits(Fuint4 x)
        {
            x = ((x >> 1) & 0x55555555) | ((x & 0x55555555) << 1);
            x = ((x >> 2) & 0x33333333) | ((x & 0x33333333) << 2);
            x = ((x >> 4) & 0x0F0F0F0F) | ((x & 0x0F0F0F0F) << 4);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2 rol(Fint2 x, int n) { return (Fint2)rol((Fuint2)x, n); }
        ...
        /// <returns>The componentwise rotated value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint3 rol(Fint3 x, int n) { return (Fint3)rol((Fuint3)x, n); }
        ...
        /// <returns>The componentwise rotated value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint4 rol(Fint4 x, int n) { return (Fint4)rol((Fuint4)x, n); }
        ...
        /// <returns>The componentwise rotated value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint2 rol(Fuint2 x, int n) { return (x << n) | (x >> (32 - n)); }
        ...
        /// <returns>The componentwise rotated value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint3 rol(Fuint3 x, int n) { return (x << n) | (x >> (32 - n)); }
        ...
        /// <returns>The componentwise rotated value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint4 rol(Fuint4 x, int n) { return (x << n) | (x >> (32 - n)); }
        ...
        /// <returns>The componentwise rotated value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2 ror(Fint2 x, int n) { return (Fint2)ror((Fuint2)x, n); }
        ...
        /// <returns>The componentwise rotated value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint3 ror(Fint3 x, int n) { return (Fint3)ror((Fuint3)x, n); }
        ...
        /// <returns>The componentwise rotated value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint4 ror(Fint4 x, int n) { return (Fint4)ror((Fuint4)x, n); }
        ...
        /// <returns>The componentwise rotated value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint2 ror(Fuint2 x, int n) { return (x >> n) | (x << (32 - n)); }
        ...
        /// <returns>The componentwise rotated value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint3 ror(Fuint3 x, int n) { return (x >> n) | (x << (32 - n)); }
        ...
        /// <returns>The componentwise rotated value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint4 ror(Fuint4 x, int n) { return (x >> n) | (x << (32 - n)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2 ceilpow2(Fint2 x)
        {
            x -= 1;
            x |= x >> 1;
            x |= x >> 2;
        ...
        /// <returns>The componentwise smallest power of two greater than or equal to the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint3 ceilpow2(Fint3 x)
        {
            x -= 1;
            x |= x >> 1;
            x |= x >> 2;
        ...
        /// <returns>The componentwise smallest power of two greater than or equal to the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint4 ceilpow2(Fint4 x)
        {
            x -= 1;
            x |= x >> 1;
            x |= x >> 2;
        ...
        /// <returns>The componentwise smallest power of two greater than or equal to the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint2 ceilpow2(Fuint2 x)
        {
            x -= 1;
            x |= x >> 1;
            x |= x >> 2;
        ...
        /// <returns>The componentwise smallest power of two greater than or equal to the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint3 ceilpow2(Fuint3 x)
        {
            x -= 1;
            x |= x >> 1;
            x |= x >> 2;
        ...
        /// <returns>The componentwise smallest power of two greater than or equal to the input.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint4 ceilpow2(Fuint4 x)
        {
            x -= 1;
            x |= x >> 1;
            x |= x >> 2;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2 ceillog2(Fint2 x)
        {
            return new Fint2(ceillog2(x.x), ceillog2(x.y));
        }
        ...
        /// <returns>Componentwise ceiling of the base-2 logarithm of x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint3 ceillog2(Fint3 x)
        {
            return new Fint3(ceillog2(x.x), ceillog2(x.y), ceillog2(x.z));
        }
        ...
        /// <returns>Componentwise ceiling of the base-2 logarithm of x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint4 ceillog2(Fint4 x)
        {
            return new Fint4(ceillog2(x.x), ceillog2(x.y), ceillog2(x.z), ceillog2(x.w));
        }
        ...
        /// <returns>Componentwise ceiling of the base-2 logarithm of x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2 ceillog2(Fuint2 x)
        {
            return new Fint2(ceillog2(x.x), ceillog2(x.y));
        }
        ...
        /// <returns>Componentwise ceiling of the base-2 logarithm of x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint3 ceillog2(Fuint3 x)
        {
            return new Fint3(ceillog2(x.x), ceillog2(x.y), ceillog2(x.z));
        }
        ...
        /// <returns>Componentwise ceiling of the base-2 logarithm of x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint4 ceillog2(Fuint4 x)
        {
            return new Fint4(ceillog2(x.x), ceillog2(x.y), ceillog2(x.z), ceillog2(x.w));
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2 floorlog2(Fint2 x)
        {
            return new Fint2(floorlog2(x.x), floorlog2(x.y));
        }
        ...
        /// <returns>Componentwise floor of base-2 logarithm of x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint3 floorlog2(Fint3 x)
        {
            return new Fint3(floorlog2(x.x), floorlog2(x.y), floorlog2(x.z));
        }
        ...
        /// <returns>Componentwise floor of base-2 logarithm of x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint4 floorlog2(Fint4 x)
        {
            return new Fint4(floorlog2(x.x), floorlog2(x.y), floorlog2(x.z), floorlog2(x.w));
        }
        ...
        /// <returns>Componentwise floor of base-2 logarithm of x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint2 floorlog2(Fuint2 x)
        {
            return new Fint2(floorlog2(x.x), floorlog2(x.y));
        }
        ...
        /// <returns>Componentwise floor of base-2 logarithm of x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint3 floorlog2(Fuint3 x)
        {
            return new Fint3(floorlog2(x.x), floorlog2(x.y), floorlog2(x.z));
        }
        ...
        /// <returns>Componentwise floor of base-2 logarithm of x.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fint4 floorlog2(Fuint4 x)
        {
            return new Fint4(floorlog2(x.x), floorlog2(x.y), floorlog2(x.z), floorlog2(x.w));
        }
        ...
        /// <returns>Vector containing angles converted to radians.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 radians(Fdouble2 x) { return x * 0.017453292519943296; }

        /// <summary>Returns the result of a componentwise conversion of a float3 vector from degrees to radians.</summary>
        /// <param name="x">Vector containing angles in degrees.</param>
        /// <returns>Vector containing angles converted to radians.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 radians(Fdouble3 x) { return x * 0.017453292519943296; }

        /// <summary>Returns the result of a componentwise conversion of a float4 vector from degrees to radians.</summary>
        /// <param name="x">Vector containing angles in degrees.</param>
        /// <returns>Vector containing angles converted to radians.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 radians(Fdouble4 x) { return x * 0.017453292519943296; }
        ...
        /// <returns>Vector containing angles converted to degrees.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2 degrees(Fdouble2 x) { return x * 57.29577951308232; }

        /// <summary>Returns the result of a componentwise conversion of a double3 vector from radians to degrees.</summary>
        /// <param name="x">Vector containing angles in radians.</param>
        /// <returns>Vector containing values converted to degrees.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble3 degrees(Fdouble3 x) { return x * 57.29577951308232; }

        /// <summary>Returns the result of a componentwise conversion of a double4 vector from radians to degrees.</summary>
        /// <param name="x">Vector containing angles in radians.</param>
        /// <returns>Vector containing angles converted to degrees.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble4 degrees(Fdouble4 x) { return x * 57.29577951308232; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int cmin(Fint2 x) { return min(x.x, x.y); }

        /// <summary>Returns the minimum component of an int3 vector.</summary>
        /// <param name="x">The vector to use when computing the minimum component.</param>
        /// <returns>The value of the minimum component of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int cmin(Fint3 x) { return min(min(x.x, x.y), x.z); }

        /// <summary>Returns the minimum component of an int4 vector.</summary>
        /// <param name="x">The vector to use when computing the minimum component.</param>
        /// <returns>The value of the minimum component of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int cmin(Fint4 x) { return min(min(x.x, x.y), min(x.z, x.w)); }
        ...
        /// <returns>The value of the minimum component of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint cmin(Fuint2 x) { return min(x.x, x.y); }

        /// <summary>Returns the minimum component of a uint3 vector.</summary>
        /// <param name="x">The vector to use when computing the minimum component.</param>
        /// <returns>The value of the minimum component of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint cmin(Fuint3 x) { return min(min(x.x, x.y), x.z); }

        /// <summary>Returns the minimum component of a uint4 vector.</summary>
        /// <param name="x">The vector to use when computing the minimum component.</param>
        /// <returns>The value of the minimum component of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint cmin(Fuint4 x) { return min(min(x.x, x.y), min(x.z, x.w)); }
        ...
        /// <returns>The value of the minimum component of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float cmin(Ffloat2 x) { return min(x.x, x.y); }

        /// <summary>Returns the minimum component of a float3 vector.</summary>
        /// <param name="x">The vector to use when computing the minimum component.</param>
        /// <returns>The value of the minimum component of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float cmin(Ffloat3 x) { return min(min(x.x, x.y), x.z); }

        /// <summary>Returns the minimum component of a float4 vector.</summary>
        /// <param name="x">The vector to use when computing the minimum component.</param>
        /// <returns>The value of the minimum component of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float cmin(Ffloat4 x) { return min(min(x.x, x.y), min(x.z, x.w)); }
        ...
        /// <returns>The value of the minimum component of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double cmin(Fdouble2 x) { return min(x.x, x.y); }

        /// <summary>Returns the minimum component of a double3 vector.</summary>
        /// <param name="x">The vector to use when computing the minimum component.</param>
        /// <returns>The value of the minimum component of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double cmin(Fdouble3 x) { return min(min(x.x, x.y), x.z); }

        /// <summary>Returns the minimum component of a double4 vector.</summary>
        /// <param name="x">The vector to use when computing the minimum component.</param>
        /// <returns>The value of the minimum component of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double cmin(Fdouble4 x) { return min(min(x.x, x.y), min(x.z, x.w)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int cmax(Fint2 x) { return max(x.x, x.y); }

        /// <summary>Returns the maximum component of an int3 vector.</summary>
        /// <param name="x">The vector to use when computing the maximum component.</param>
        /// <returns>The value of the maximum component of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int cmax(Fint3 x) { return max(max(x.x, x.y), x.z); }

        /// <summary>Returns the maximum component of an int4 vector.</summary>
        /// <param name="x">The vector to use when computing the maximum component.</param>
        /// <returns>The value of the maximum component of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int cmax(Fint4 x) { return max(max(x.x, x.y), max(x.z, x.w)); }
        ...
        /// <returns>The value of the maximum component of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint cmax(Fuint2 x) { return max(x.x, x.y); }

        /// <summary>Returns the maximum component of a uint3 vector.</summary>
        /// <param name="x">The vector to use when computing the maximum component.</param>
        /// <returns>The value of the maximum component of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint cmax(Fuint3 x) { return max(max(x.x, x.y), x.z); }

        /// <summary>Returns the maximum component of a uint4 vector.</summary>
        /// <param name="x">The vector to use when computing the maximum component.</param>
        /// <returns>The value of the maximum component of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint cmax(Fuint4 x) { return max(max(x.x, x.y), max(x.z, x.w)); }
        ...
        /// <returns>The value of the maximum component of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float cmax(Ffloat2 x) { return max(x.x, x.y); }

        /// <summary>Returns the maximum component of a float3 vector.</summary>
        /// <param name="x">The vector to use when computing the maximum component.</param>
        /// <returns>The value of the maximum component of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float cmax(Ffloat3 x) { return max(max(x.x, x.y), x.z); }

        /// <summary>Returns the maximum component of a float4 vector.</summary>
        /// <param name="x">The vector to use when computing the maximum component.</param>
        /// <returns>The value of the maximum component of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float cmax(Ffloat4 x) { return max(max(x.x, x.y), max(x.z, x.w)); }
        ...
        /// <returns>The value of the maximum component of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double cmax(Fdouble2 x) { return max(x.x, x.y); }

        /// <summary>Returns the maximum component of a double3 vector.</summary>
        /// <param name="x">The vector to use when computing the maximum component.</param>
        /// <returns>The value of the maximum component of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double cmax(Fdouble3 x) { return max(max(x.x, x.y), x.z); }

        /// <summary>Returns the maximum component of a double4 vector.</summary>
        /// <param name="x">The vector to use when computing the maximum component.</param>
        /// <returns>The value of the maximum component of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double cmax(Fdouble4 x) { return max(max(x.x, x.y), max(x.z, x.w)); }
        ...
        /// <returns>The horizontal sum of of components of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint csum(Fuint2 x) { return x.x + x.y; }

        /// <summary>Returns the horizontal sum of components of a uint3 vector.</summary>
        /// <param name="x">The vector to use when computing the horizontal sum.</param>
        /// <returns>The horizontal sum of of components of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint csum(Fuint3 x) { return x.x + x.y + x.z; }

        /// <summary>Returns the horizontal sum of components of a uint4 vector.</summary>
        /// <param name="x">The vector to use when computing the horizontal sum.</param>
        /// <returns>The horizontal sum of of components of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint csum(Fuint4 x) { return x.x + x.y + x.z + x.w; }
        ...
        /// <returns>The horizontal sum of of components of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float csum(Ffloat2 x) { return x.x + x.y; }

        /// <summary>Returns the horizontal sum of components of a float3 vector.</summary>
        /// <param name="x">The vector to use when computing the horizontal sum.</param>
        /// <returns>The horizontal sum of of components of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float csum(Ffloat3 x) { return x.x + x.y + x.z; }

        /// <summary>Returns the horizontal sum of components of a float4 vector.</summary>
        /// <param name="x">The vector to use when computing the horizontal sum.</param>
        /// <returns>The horizontal sum of of components of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float csum(Ffloat4 x) { return (x.x + x.y) + (x.z + x.w); }
        ...
        /// <returns>The horizontal sum of of components of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double csum(Fdouble2 x) { return x.x + x.y; }

        /// <summary>Returns the horizontal sum of components of a double3 vector.</summary>
        /// <param name="x">The vector to use when computing the horizontal sum.</param>
        /// <returns>The horizontal sum of of components of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double csum(Fdouble3 x) { return x.x + x.y + x.z; }

        /// <summary>Returns the horizontal sum of components of a double4 vector.</summary>
        /// <param name="x">The vector to use when computing the horizontal sum.</param>
        /// <returns>The horizontal sum of of components of the vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double csum(Fdouble4 x) { return (x.x + x.y) + (x.z + x.w); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe int compress(int* output, int index, Fint4 val, Fbool4 mask)
        {
            if (mask.x)
                output[index++] = val.x;
            if (mask.y)
        ...
        /// <returns>Index to element after the last one stored.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe int compress(uint* output, int index, Fuint4 val, Fbool4 mask)
        {
            return compress((int*)output, index, *(Fint4*)&val, mask);
        }
        ...
        /// <returns>Index to element after the last one stored.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe int compress(float* output, int index, Ffloat4 val, Fbool4 mask)
        {
            return compress((int*)output, index, *(Fint4*)&val, mask);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2 f16tof32(Fuint2 x)
        {
            const uint shifted_exp = (0x7c00 << 13);
            Fuint2 uf = (x & 0x7fff) << 13;
            Fuint2 e = uf & shifted_exp;
            uf += (127 - 15) << 23;
            uf += select(0, (128u - 16u) << 23, e == shifted_exp);
            uf = select(uf, asuint(asfloat(uf + (1 << 23)) - 6.10351563e-05f), e == 0);
            uf |= (x & 0x8000) << 16;
        ...
        /// <returns>The single precision float vector representation of the half precision float vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 f16tof32(Fuint3 x)
        {
            const uint shifted_exp = (0x7c00 << 13);
            Fuint3 uf = (x & 0x7fff) << 13;
            Fuint3 e = uf & shifted_exp;
            uf += (127 - 15) << 23;
            uf += select(0, (128u - 16u) << 23, e == shifted_exp);
            uf = select(uf, asuint(asfloat(uf + (1 << 23)) - 6.10351563e-05f), e == 0);
            uf |= (x & 0x8000) << 16;
        ...
        /// <returns>The single precision float vector representation of the half precision float vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4 f16tof32(Fuint4 x)
        {
            const uint shifted_exp = (0x7c00 << 13);
            Fuint4 uf = (x & 0x7fff) << 13;
            Fuint4 e = uf & shifted_exp;
            uf += (127 - 15) << 23;
            uf += select(0, (128u - 16u) << 23, e == shifted_exp);
            uf = select(uf, asuint(asfloat(uf + (1 << 23)) - 6.10351563e-05f), e == 0);
            uf |= (x & 0x8000) << 16;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint2 f32tof16(Ffloat2 x)
        {
            const int infinity_32 = 255 << 23;
            const uint msk = 0x7FFFF000u;
            ...
            Fuint2 ux = asuint(x);
            Fuint2 uux = ux & msk;
            Fuint2 h = (Fuint2)(asint(min(asfloat(uux) * 1.92592994e-34f, 260042752.0f)) + 0x1000) >> 13;   // Clamp to signed infinity if overflowed
            h = select(h, select(0x7c00u, 0x7e00u, (Fint2)uux > infinity_32), (Fint2)uux >= infinity_32);   // NaN->qNaN and Inf->Inf
            return h | (ux & ~msk) >> 16;
        }
        ...
        /// <returns>The half precision float vector representation of the single precision float vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint3 f32tof16(Ffloat3 x)
        {
            const int infinity_32 = 255 << 23;
            const uint msk = 0x7FFFF000u;
            ...
            Fuint3 ux = asuint(x);
            Fuint3 uux = ux & msk;
            Fuint3 h = (Fuint3)(asint(min(asfloat(uux) * 1.92592994e-34f, 260042752.0f)) + 0x1000) >> 13;   // Clamp to signed infinity if overflowed
            h = select(h, select(0x7c00u, 0x7e00u, (Fint3)uux > infinity_32), (Fint3)uux >= infinity_32);   // NaN->qNaN and Inf->Inf
            return h | (ux & ~msk) >> 16;
        }
        ...
        /// <returns>The half precision float vector representation of the single precision float vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint4 f32tof16(Ffloat4 x)
        {
            const int infinity_32 = 255 << 23;
            const uint msk = 0x7FFFF000u;
            ...
            Fuint4 ux = asuint(x);
            Fuint4 uux = ux & msk;
            Fuint4 h = (Fuint4)(asint(min(asfloat(uux) * 1.92592994e-34f, 260042752.0f)) + 0x1000) >> 13;   // Clamp to signed infinity if overflowed
            h = select(h, select(0x7c00u, 0x7e00u, (Fint4)uux > infinity_32), (Fint4)uux >= infinity_32);   // NaN->qNaN and Inf->Inf
            return h | (ux & ~msk) >> 16;
        }
        ...
        public static unsafe uint hash(void* pBuffer, int numBytes, uint seed = 0)
        {
            unchecked
            {
                ...
                Fuint4* p = (Fuint4*)pBuffer;
                uint hash = seed + Prime5;
                if (numBytes >= 16)
                {
                    Fuint4 state = new Fuint4(Prime1 + Prime2, Prime2, 0, (uint)-Prime1) + seed;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 up() { return new Ffloat3(0.0f, 1.0f, 0.0f); }  // for compatibility
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 down() { return new Ffloat3(0.0f, -1.0f, 0.0f); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 forward() { return new Ffloat3(0.0f, 0.0f, 1.0f); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 back() { return new Ffloat3(0.0f, 0.0f, -1.0f); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 left() { return new Ffloat3(-1.0f, 0.0f, 0.0f); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3 right() { return new Ffloat3(1.0f, 0.0f, 0.0f); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static Fuint2 fold_to_uint(Fdouble2 x) { return uint2(fold_to_uint(x.x), fold_to_uint(x.y)); }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static Fuint3 fold_to_uint(Fdouble3 x) { return uint3(fold_to_uint(x.x), fold_to_uint(x.y), fold_to_uint(x.z)); }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static Fuint4 fold_to_uint(Fdouble4 x) { return uint4(fold_to_uint(x.x), fold_to_uint(x.y), fold_to_uint(x.z), fold_to_uint(x.w)); }
