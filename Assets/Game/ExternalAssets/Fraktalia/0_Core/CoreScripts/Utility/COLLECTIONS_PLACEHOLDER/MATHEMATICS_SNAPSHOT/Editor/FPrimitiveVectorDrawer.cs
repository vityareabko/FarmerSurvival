...
{
    [CustomPropertyDrawer(typeof(Fbool2)), CustomPropertyDrawer(typeof(Fbool3)), CustomPropertyDrawer(typeof(Fbool4))]
    [CustomPropertyDrawer(typeof(Fdouble2)), CustomPropertyDrawer(typeof(Fdouble3)), CustomPropertyDrawer(typeof(Fdouble4))]
    [CustomPropertyDrawer(typeof(Ffloat2)), CustomPropertyDrawer(typeof(Ffloat3)), CustomPropertyDrawer(typeof(Ffloat4))]
    [CustomPropertyDrawer(typeof(Fint2)), CustomPropertyDrawer(typeof(Fint3)), CustomPropertyDrawer(typeof(Fint4))]
    [CustomPropertyDrawer(typeof(Fuint2)), CustomPropertyDrawer(typeof(Fuint3)), CustomPropertyDrawer(typeof(Fuint4))]
    [CustomPropertyDrawer(typeof(FDoNotNormalizeAttribute))]
    class FPrimitiveVectorDrawer : PropertyDrawer
    {
        ...
        static class Content
        {
            public static readonly string doNotNormalizeCompatibility = L10n.Tr(
                $"{typeof(FDoNotNormalizeAttribute).Name} only works with {typeof(Fquaternion)} and primitive vector types."
            );
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            switch (propertyType[propertyType.Length - 1])
            {
                ...
                default:
                {
                    if (property.type == nameof(Fquaternion))
                        startIter = "value.x";
                    else if (attribute is FDoNotNormalizeAttribute)
                    {
            ...
            if (attribute is FDoNotNormalizeAttribute && string.IsNullOrEmpty(label.tooltip))
