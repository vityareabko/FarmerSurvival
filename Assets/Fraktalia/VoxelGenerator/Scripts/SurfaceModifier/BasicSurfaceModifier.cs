...
namespace Fraktalia.VoxelGen.Visualisation
{
	...
	public class BasicSurfaceModifier : MonoBehaviour
	{
		...
		public void InitVisualHull(int slots)
		{
			...
			if (!engine) engine = GetComponentInParent<VoxelGenerator>();
			Initialize();			
		}		
		...
		{
			return MathUtilities.Bools2Int(enabled, Locked, LockAfterGeneration, NoCollision, ConvexCollider, Invisible);
		}
		...
		{	
			VoxelPiece piece = BasicNativeVisualHull.CreateVoxelPieceObject(transform, usedHideflags);
