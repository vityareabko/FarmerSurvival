...
namespace Fraktalia.Core.Mathematics
{
    ...
    public partial struct FRandom
    {
        ...
        /// <summary>
        /// Constructs a <see cref="FRandom"/> instance with an index that gets hashed.  The index must not be uint.MaxValue.
        /// </summary>
        /// <remarks>
        ...
        /// <returns><see cref="FRandom"/> created from an index.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FRandom CreateFromIndex(uint index)
        {
            ...
            return new FRandom(WangHash(index + 62u));
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fint2 NextInt2(Fint2 max)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fint3 NextInt3(Fint3 max)
        {
            CheckNextIntMax(max.x);
            CheckNextIntMax(max.y);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fint4 NextInt4(Fint4 max)
        {
            CheckNextIntMax(max.x);
            CheckNextIntMax(max.y);
            CheckNextIntMax(max.z);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fint2 NextInt2(Fint2 min, Fint2 max)
        {
            CheckNextIntMinMax(min.x, max.x);
            CheckNextIntMinMax(min.y, max.y);
            Fuint2 range = (Fuint2)(max - min);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fint3 NextInt3(Fint3 min, Fint3 max)
        {
            CheckNextIntMinMax(min.x, max.x);
            CheckNextIntMinMax(min.y, max.y);
            CheckNextIntMinMax(min.z, max.z);
            Fuint3 range = (Fuint3)(max - min);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fint4 NextInt4(Fint4 min, Fint4 max)
        {
            CheckNextIntMinMax(min.x, max.x);
            CheckNextIntMinMax(min.y, max.y);
            CheckNextIntMinMax(min.z, max.z);
            CheckNextIntMinMax(min.w, max.w);
            Fuint4 range = (Fuint4)(max - min);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fuint2 NextUInt2(Fuint2 max)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fuint3 NextUInt3(Fuint3 max)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fuint4 NextUInt4(Fuint4 max)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fuint2 NextUInt2(Fuint2 min, Fuint2 max)
        {
            CheckNextUIntMinMax(min.x, max.x);
            CheckNextUIntMinMax(min.y, max.y);
            Fuint2 range = max - min;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fuint3 NextUInt3(Fuint3 min, Fuint3 max)
        {
            CheckNextUIntMinMax(min.x, max.x);
            CheckNextUIntMinMax(min.y, max.y);
            CheckNextUIntMinMax(min.z, max.z);
            Fuint3 range = max - min;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fuint4 NextUInt4(Fuint4 min, Fuint4 max)
        {
            CheckNextUIntMinMax(min.x, max.x);
            CheckNextUIntMinMax(min.y, max.y);
            CheckNextUIntMinMax(min.z, max.z);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Ffloat2 NextFloat2(Ffloat2 max) { return NextFloat2() * max; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Ffloat3 NextFloat3(Ffloat3 max) { return NextFloat3() * max; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Ffloat4 NextFloat4(Ffloat4 max) { return NextFloat4() * max; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Ffloat2 NextFloat2(Ffloat2 min, Ffloat2 max) { return NextFloat2() * (max - min) + min; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Ffloat3 NextFloat3(Ffloat3 min, Ffloat3 max) { return NextFloat3() * (max - min) + min; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Ffloat4 NextFloat4(Ffloat4 min, Ffloat4 max) { return NextFloat4() * (max - min) + min; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fdouble2 NextDouble2(Fdouble2 max) { return NextDouble2() * max; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fdouble3 NextDouble3(Fdouble3 max) { return NextDouble3() * max; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fdouble4 NextDouble4(Fdouble4 max) { return NextDouble4() * max; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fdouble2 NextDouble2(Fdouble2 min, Fdouble2 max) { return NextDouble2() * (max - min) + min; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fdouble3 NextDouble3(Fdouble3 min, Fdouble3 max) { return NextDouble3() * (max - min) + min; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fdouble4 NextDouble4(Fdouble4 min, Fdouble4 max) { return NextDouble4() * (max - min) + min; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Ffloat2 NextFloat2Direction()
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fdouble2 NextDouble2Direction()
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Ffloat3 NextFloat3Direction()
        {
            Ffloat2 rnd = NextFloat2();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fdouble3 NextDouble3Direction()
        {
            Fdouble2 rnd = NextDouble2();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fquaternion NextQuaternionRotation()
        {
            Ffloat3 rnd = NextFloat3(float3(2.0f * PI, 2.0f * PI, 1.0f));
            float u1 = rnd.z;
            Ffloat2 theta_rho = rnd.xy;

            float i = sqrt(1.0f - u1);
            float j = sqrt(u1);

            Ffloat2 sin_theta_rho;
            Ffloat2 cos_theta_rho;
            sincos(theta_rho, out sin_theta_rho, out cos_theta_rho);

            Fquaternion q = quaternion(i * sin_theta_rho.x, i * cos_theta_rho.x, j * sin_theta_rho.y, j * cos_theta_rho.y);
