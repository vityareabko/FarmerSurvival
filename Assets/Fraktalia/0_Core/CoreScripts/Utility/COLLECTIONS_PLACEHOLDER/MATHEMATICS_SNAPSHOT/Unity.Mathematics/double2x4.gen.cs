...
namespace Fraktalia.Core.Mathematics
{
    ...
    public partial struct Fdouble2x4 : System.IEquatable<Fdouble2x4>, IFormattable
    {
        ...
        public static readonly Fdouble2x4 zero;
        ...
        public Fdouble2x4(Fdouble2 c0, Fdouble2 c1, Fdouble2 c2, Fdouble2 c3)
        {
            this.c0 = c0;
            this.c1 = c1;
            this.c2 = c2;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fdouble2x4(double m00, double m01, double m02, double m03,
                         double m10, double m11, double m12, double m13)
        {
            this.c0 = new Fdouble2(m00, m10);
            this.c1 = new Fdouble2(m01, m11);
            this.c2 = new Fdouble2(m02, m12);
            this.c3 = new Fdouble2(m03, m13);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fdouble2x4(bool v)
        {
            this.c0 = Fmath.select(new Fdouble2(0.0), new Fdouble2(1.0), v);
            this.c1 = Fmath.select(new Fdouble2(0.0), new Fdouble2(1.0), v);
            this.c2 = Fmath.select(new Fdouble2(0.0), new Fdouble2(1.0), v);
            this.c3 = Fmath.select(new Fdouble2(0.0), new Fdouble2(1.0), v);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fdouble2x4(Fbool2x4 v)
        {
            this.c0 = Fmath.select(new Fdouble2(0.0), new Fdouble2(1.0), v.c0);
            this.c1 = Fmath.select(new Fdouble2(0.0), new Fdouble2(1.0), v.c1);
            this.c2 = Fmath.select(new Fdouble2(0.0), new Fdouble2(1.0), v.c2);
            this.c3 = Fmath.select(new Fdouble2(0.0), new Fdouble2(1.0), v.c3);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Fdouble2x4(double v) { return new Fdouble2x4(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Fdouble2x4(bool v) { return new Fdouble2x4(v); }

        /// <summary>Explicitly converts a bool2x4 matrix to a double2x4 matrix by componentwise conversion.</summary>
        /// <param name="v">bool2x4 to convert to double2x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Fdouble2x4(Fbool2x4 v) { return new Fdouble2x4(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Fdouble2x4(int v) { return new Fdouble2x4(v); }

        /// <summary>Implicitly converts a int2x4 matrix to a double2x4 matrix by componentwise conversion.</summary>
        /// <param name="v">int2x4 to convert to double2x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Fdouble2x4(Fint2x4 v) { return new Fdouble2x4(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Fdouble2x4(uint v) { return new Fdouble2x4(v); }

        /// <summary>Implicitly converts a uint2x4 matrix to a double2x4 matrix by componentwise conversion.</summary>
        /// <param name="v">uint2x4 to convert to double2x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Fdouble2x4(Fuint2x4 v) { return new Fdouble2x4(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Fdouble2x4(float v) { return new Fdouble2x4(v); }

        /// <summary>Implicitly converts a float2x4 matrix to a double2x4 matrix by componentwise conversion.</summary>
        /// <param name="v">float2x4 to convert to double2x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Fdouble2x4(Ffloat2x4 v) { return new Fdouble2x4(v); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2x4 operator * (Fdouble2x4 lhs, Fdouble2x4 rhs) { return new Fdouble2x4 (lhs.c0 * rhs.c0, lhs.c1 * rhs.c1, lhs.c2 * rhs.c2, lhs.c3 * rhs.c3); }
        ...
        /// <returns>double2x4 result of the componentwise multiplication.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2x4 operator * (Fdouble2x4 lhs, double rhs) { return new Fdouble2x4 (lhs.c0 * rhs, lhs.c1 * rhs, lhs.c2 * rhs, lhs.c3 * rhs); }
        ...
        /// <returns>double2x4 result of the componentwise multiplication.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2x4 operator * (double lhs, Fdouble2x4 rhs) { return new Fdouble2x4 (lhs * rhs.c0, lhs * rhs.c1, lhs * rhs.c2, lhs * rhs.c3); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2x4 operator ++ (Fdouble2x4 val) { return new Fdouble2x4 (++val.c0, ++val.c1, ++val.c2, ++val.c3); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool2x4 operator < (Fdouble2x4 lhs, Fdouble2x4 rhs) { return new Fbool2x4 (lhs.c0 < rhs.c0, lhs.c1 < rhs.c1, lhs.c2 < rhs.c2, lhs.c3 < rhs.c3); }
        ...
        /// <returns>bool2x4 result of the componentwise less than.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool2x4 operator < (Fdouble2x4 lhs, double rhs) { return new Fbool2x4 (lhs.c0 < rhs, lhs.c1 < rhs, lhs.c2 < rhs, lhs.c3 < rhs); }
        ...
        /// <returns>bool2x4 result of the componentwise less than.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fbool2x4 operator < (double lhs, Fdouble2x4 rhs) { return new Fbool2x4 (lhs < rhs.c0, lhs < rhs.c1, lhs < rhs.c2, lhs < rhs.c3); }
        ...
        unsafe public ref Fdouble2 this[int index]
        {
            get
            {
...
#endif
                fixed (Fdouble2x4* array = &this) { return ref ((Fdouble2*)array)[index]; }
            }
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(Fdouble2x4 rhs) { return c0.Equals(rhs.c0) && c1.Equals(rhs.c1) && c2.Equals(rhs.c2) && c3.Equals(rhs.c3); }

        /// <summary>Returns true if the double2x4 is equal to a given double2x4, false otherwise.</summary>
        /// <param name="o">Right hand side argument to compare equality with.</param>
        /// <returns>The result of the equality comparison.</returns>
        public override bool Equals(object o) { return o is Fdouble2x4 converted && Equals(converted); }
    ...
    public static partial class Fmath
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2x4 double2x4(Fdouble2 c0, Fdouble2 c1, Fdouble2 c2, Fdouble2 c3) { return new Fdouble2x4(c0, c1, c2, c3); }
        ...
        /// <returns>double2x4 constructed from arguments.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2x4 double2x4(double m00, double m01, double m02, double m03,
                                          double m10, double m11, double m12, double m13)
        {
            return new Fdouble2x4(m00, m01, m02, m03,
                                 m10, m11, m12, m13);
        }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2x4 double2x4(double v) { return new Fdouble2x4(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2x4 double2x4(bool v) { return new Fdouble2x4(v); }

        /// <summary>Return a double2x4 matrix constructed from a bool2x4 matrix by componentwise conversion.</summary>
        /// <param name="v">bool2x4 to convert to double2x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2x4 double2x4(Fbool2x4 v) { return new Fdouble2x4(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2x4 double2x4(int v) { return new Fdouble2x4(v); }

        /// <summary>Return a double2x4 matrix constructed from a int2x4 matrix by componentwise conversion.</summary>
        /// <param name="v">int2x4 to convert to double2x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2x4 double2x4(Fint2x4 v) { return new Fdouble2x4(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2x4 double2x4(uint v) { return new Fdouble2x4(v); }

        /// <summary>Return a double2x4 matrix constructed from a uint2x4 matrix by componentwise conversion.</summary>
        /// <param name="v">uint2x4 to convert to double2x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fdouble2x4 double2x4(Fuint2x4 v) { return new Fdouble2x4(v); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint hash(Fdouble2x4 v)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Fuint2 hashwide(Fdouble2x4 v)
        {
