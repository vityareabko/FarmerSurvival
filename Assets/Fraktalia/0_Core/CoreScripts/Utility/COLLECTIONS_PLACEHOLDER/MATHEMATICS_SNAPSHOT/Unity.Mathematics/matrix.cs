...
{
    public partial struct Ffloat2x2
    {
        /// <summary>
        ...
        public static Ffloat2x2 Rotate(float angle)
        {
            float s, c;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2x2 Scale(float s)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2x2 Scale(float x, float y)
        {
        ...
        /// <returns>The float2x2 matrix representing a non-uniform scale.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat2x2 Scale(Ffloat2 v)
        {
            return Scale(v.x, v.y);
        }
    }

    public partial struct Ffloat3x3
    {
        /// <summary>
        /// Constructs a float3x3 from the upper left 3x3 of a float4x4.
        /// </summary>
        /// <param name="f4x4"><see cref="Ffloat4x4"/> to extract a float3x3 from.</param>
        public Ffloat3x3(Ffloat4x4 f4x4)
        {
            c0 = f4x4.c0.xyz;
            c1 = f4x4.c1.xyz;
            c2 = f4x4.c2.xyz;
        ...
        public Ffloat3x3(Fquaternion q)
        {
            Ffloat4 v = q.value;
            Ffloat4 v2 = v + v;

            Fuint3 npn = uint3(0x80000000, 0x00000000, 0x80000000);
            Fuint3 nnp = uint3(0x80000000, 0x80000000, 0x00000000);
            Fuint3 pnn = uint3(0x00000000, 0x80000000, 0x80000000);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x3 AxisAngle(Ffloat3 axis, float angle)
        {
            float sina, cosa;
            Fmath.sincos(angle, out sina, out cosa);

            Ffloat3 u = axis;
            Ffloat3 u_yzx = u.yzx;
            Ffloat3 u_zxy = u.zxy;
            Ffloat3 u_inv_cosa = u - u * cosa;  // u * (1.0f - cosa);
            Ffloat4 t = float4(u * sina, cosa);

            Fuint3 ppn = uint3(0x00000000, 0x00000000, 0x80000000);
            Fuint3 npp = uint3(0x80000000, 0x00000000, 0x00000000);
            Fuint3 pnp = uint3(0x00000000, 0x80000000, 0x00000000);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x3 EulerXYZ(Ffloat3 xyz)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x3 EulerXZY(Ffloat3 xyz)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x3 EulerYXZ(Ffloat3 xyz)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x3 EulerYZX(Ffloat3 xyz)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x3 EulerZXY(Ffloat3 xyz)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x3 EulerZYX(Ffloat3 xyz)
        {
        ...
        /// <returns>The float3x3 rotation matrix representing the rotation by Euler angles in x-y-z order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x3 EulerXYZ(float x, float y, float z) { return EulerXYZ(float3(x, y, z)); }
        ...
        /// <returns>The float3x3 rotation matrix representing the rotation by Euler angles in x-z-y order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x3 EulerXZY(float x, float y, float z) { return EulerXZY(float3(x, y, z)); }
        ...
        /// <returns>The float3x3 rotation matrix representing the rotation by Euler angles in y-x-z order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x3 EulerYXZ(float x, float y, float z) { return EulerYXZ(float3(x, y, z)); }
        ...
        /// <returns>The float3x3 rotation matrix representing the rotation by Euler angles in y-z-x order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x3 EulerYZX(float x, float y, float z) { return EulerYZX(float3(x, y, z)); }
        ...
        /// <returns>The float3x3 rotation matrix representing the rotation by Euler angles in z-x-y order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x3 EulerZXY(float x, float y, float z) { return EulerZXY(float3(x, y, z)); }
        ...
        /// <returns>The float3x3 rotation matrix representing the rotation by Euler angles in z-y-x order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x3 EulerZYX(float x, float y, float z) { return EulerZYX(float3(x, y, z)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x3 Euler(Ffloat3 xyz, RotationOrder order = RotationOrder.Default)
        {
            switch (order)
            {
        ...
        /// <returns>The float3x3 rotation matrix representing the rotation by Euler angles in the given order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x3 Euler(float x, float y, float z, RotationOrder order = RotationOrder.Default)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x3 RotateX(float angle)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x3 RotateY(float angle)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x3 RotateZ(float angle)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x3 Scale(float s)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x3 Scale(float x, float y, float z)
        {
        ...
        /// <returns>The float3x3 rotation matrix representing a non-uniform scale.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x3 Scale(Ffloat3 v)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x3 LookRotation(Ffloat3 forward, Ffloat3 up)
        {
            Ffloat3 t = normalize(cross(up, forward));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x3 LookRotationSafe(Ffloat3 forward, Ffloat3 up)
        {
        ...
        public static explicit operator Ffloat3x3(Ffloat4x4 f4x4) => new Ffloat3x3(f4x4);
    }
    ...
    public partial struct Ffloat4x4
    {
        ...
        public Ffloat4x4(Ffloat3x3 rotation, Ffloat3 translation)
        {
        ...
        /// <param name="translation">The translation vector.</param>
        public Ffloat4x4(Fquaternion rotation, Ffloat3 translation)
        {
            Ffloat3x3 rot = float3x3(rotation);
        ...
        public Ffloat4x4(FRigidTransform transform)
        {
            Ffloat3x3 rot = float3x3(transform.rot);
            c0 = float4(rot.c0, 0.0f);
            c1 = float4(rot.c1, 0.0f);
            c2 = float4(rot.c2, 0.0f);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 AxisAngle(Ffloat3 axis, float angle)
        {
            float sina, cosa;
            Fmath.sincos(angle, out sina, out cosa);

            Ffloat4 u = float4(axis, 0.0f);
            Ffloat4 u_yzx = u.yzxx;
            Ffloat4 u_zxy = u.zxyx;
            Ffloat4 u_inv_cosa = u - u * cosa;  // u * (1.0f - cosa);
            Ffloat4 t = float4(u.xyz * sina, cosa);

            Fuint4 ppnp = uint4(0x00000000, 0x00000000, 0x80000000, 0x00000000);
            Fuint4 nppp = uint4(0x80000000, 0x00000000, 0x00000000, 0x00000000);
            Fuint4 pnpp = uint4(0x00000000, 0x80000000, 0x00000000, 0x00000000);
            Fuint4 mask = uint4(0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x00000000);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 EulerXYZ(Ffloat3 xyz)
        {
            // return mul(rotateZ(xyz.z), mul(rotateY(xyz.y), rotateX(xyz.x)));
            Ffloat3 s, c;
            sincos(xyz, out s, out c);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 EulerXZY(Ffloat3 xyz)
        {
            // return mul(rotateY(xyz.y), mul(rotateZ(xyz.z), rotateX(xyz.x))); }
            Ffloat3 s, c;
            sincos(xyz, out s, out c);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 EulerYXZ(Ffloat3 xyz)
        {
            // return mul(rotateZ(xyz.z), mul(rotateX(xyz.x), rotateY(xyz.y)));
            Ffloat3 s, c;
            sincos(xyz, out s, out c);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 EulerYZX(Ffloat3 xyz)
        {
            // return mul(rotateX(xyz.x), mul(rotateZ(xyz.z), rotateY(xyz.y)));
            Ffloat3 s, c;
            sincos(xyz, out s, out c);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 EulerZXY(Ffloat3 xyz)
        {
            // return mul(rotateY(xyz.y), mul(rotateX(xyz.x), rotateZ(xyz.z)));
            Ffloat3 s, c;
            sincos(xyz, out s, out c);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 EulerZYX(Ffloat3 xyz)
        {
            // return mul(rotateX(xyz.x), mul(rotateY(xyz.y), rotateZ(xyz.z)));
            Ffloat3 s, c;
            sincos(xyz, out s, out c);
        ...
        /// <returns>The float4x4 rotation matrix of the Euler angle rotation in x-y-z order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 EulerXYZ(float x, float y, float z) { return EulerXYZ(float3(x, y, z)); }
        ...
        /// <returns>The float4x4 rotation matrix of the Euler angle rotation in x-z-y order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 EulerXZY(float x, float y, float z) { return EulerXZY(float3(x, y, z)); }
        ...
        /// <returns>The float4x4 rotation matrix of the Euler angle rotation in y-x-z order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 EulerYXZ(float x, float y, float z) { return EulerYXZ(float3(x, y, z)); }
        ...
        /// <returns>The float4x4 rotation matrix of the Euler angle rotation in y-z-x order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 EulerYZX(float x, float y, float z) { return EulerYZX(float3(x, y, z)); }
        ...
        /// <returns>The float4x4 rotation matrix of the Euler angle rotation in z-x-y order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 EulerZXY(float x, float y, float z) { return EulerZXY(float3(x, y, z)); }
        ...
        /// <returns>The float4x4 rotation matrix of the Euler angle rotation in z-y-x order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 EulerZYX(float x, float y, float z) { return EulerZYX(float3(x, y, z)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 Euler(Ffloat3 xyz, RotationOrder order = RotationOrder.Default)
        {
            switch (order)
            {
                case RotationOrder.XYZ:
        ...
        /// <returns>The float4x4 rotation matrix of the Euler angle rotation in given order.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 Euler(float x, float y, float z, RotationOrder order = RotationOrder.Default)
        {
            return Euler(float3(x, y, z), order);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 RotateX(float angle)
        {
            // {{1, 0, 0}, {0, c_0, -s_0}, {0, s_0, c_0}}
            float s, c;
            sincos(angle, out s, out c);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 RotateY(float angle)
        {
            // {{c_1, 0, s_1}, {0, 1, 0}, {-s_1, 0, c_1}}
            float s, c;
            sincos(angle, out s, out c);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 RotateZ(float angle)
        {
            // {{c_2, -s_2, 0}, {s_2, c_2, 0}, {0, 0, 1}}
            float s, c;
            sincos(angle, out s, out c);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 Scale(float s)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 Scale(float x, float y, float z)
        {
        ...
        /// <returns>The float4x4 matrix that represents a non-uniform scale.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 Scale(Ffloat3 scales)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 Translate(Ffloat3 vector)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 LookAt(Ffloat3 eye, Ffloat3 target, Ffloat3 up)
        {
            Ffloat3x3 rot = Ffloat3x3.LookRotation(normalize(target - eye), up);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 Ortho(float width, float height, float near, float far)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 OrthoOffCenter(float left, float right, float bottom, float top, float near, float far)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 PerspectiveFov(float verticalFov, float aspect, float near, float far)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 PerspectiveOffCenter(float left, float right, float bottom, float top, float near, float far)
        {
            float rcpdz = 1.0f / (near - far);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 TRS(Ffloat3 translation, Fquaternion rotation, Ffloat3 scale)
        {
            Ffloat3x3 r = float3x3(rotation);
    ...
    partial class Fmath
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x3 float3x3(Ffloat4x4 f4x4)
        {
            return new Ffloat3x3(f4x4);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x3 float3x3(Fquaternion rotation)
        {
            return new Ffloat3x3(rotation);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 float4x4(Ffloat3x3 rotation, Ffloat3 translation)
        {
            return new Ffloat4x4(rotation, translation);
        }
        ...
        /// <returns>The float4x4 constructed from a rotation and translation.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 float4x4(Fquaternion rotation, Ffloat3 translation)
        {
            return new Ffloat4x4(rotation, translation);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat4x4 float4x4(FRigidTransform transform)
        {
            return new Ffloat4x4(transform);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ffloat3x3 orthonormalize(Ffloat3x3 i)
        {
            Ffloat3x3 o;

            Ffloat3 u = i.c0;
            Ffloat3 v = i.c1 - i.c0 * Fmath.dot(i.c1, i.c0);

            float lenU = Fmath.length(u);
            float lenV = Fmath.length(v);

            bool c = lenU > 1e-30f && lenV > 1e-30f;

            o.c0 = Fmath.select(float3(1, 0, 0), u / lenU, c);
            o.c1 = Fmath.select(float3(0, 1, 0), v / lenV, c);
            o.c2 = Fmath.cross(o.c0, o.c1);
