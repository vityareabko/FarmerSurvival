Shader "Fraktalia/Core/MultiTexture/MultiTextureArray_UV3_Tesselation_Triplanar"
{
    Properties
    {
        ...
        [KeywordDependent(TESSELLATION)] _EdgeLength("Edge Length Tesselation", Range(2, 50)) = 5
        [KeywordDependent(TESSELLATION)] _Phong ("Phong Strengh", Range(0,1)) = 0.5
        [KeywordDependent(TESSELLATION)] _TesselationPower("Height Map Tesselation", Range(-100, 100)) = 1
...
#pragma shader_feature SEAMLESS_TESSELATION
    ...
    FallBack "Diffuse"
    CustomEditor "Fraktalia.Core.FraktaliaAttributes.TextureArrayGUI"
}
