Shader "Fraktalia/Core/MultiTexture/Texture2D_UVBlend"
{
    Properties
    {
...
#pragma shader_feature SEAMLESS_TESSELATION
        ...
        {           
            ...
            float base = CalculateBaseTesselationLayer(uv, bf, layer0factor);
#endif
            ...
            float layeruv3 = CalculateTesselationLayer(uv, bf, layer1factor, _UV3XPower.z);
            float layeruv4 = CalculateTesselationLayer(uv, bf, layer2factor, _UV3YPower.z);
            float layeruv5 = CalculateTesselationLayer(uv, bf, layer3factor, _UV4XPower.z);
            float layeruv6 = CalculateTesselationLayer(uv, bf, layer4factor, _UV4YPower.z);
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            layer0factor /= sumPower;
            layer0factor = clamp(layer0factor, 0, 1);
            Result base = CalculateBaseLayer(IN, uv, bf, layer0factor);
#endif
            layer1factor /= sumPower;
            layer2factor /= sumPower;
            layer3factor /= sumPower;
            ...
            Result layeruv3 = CalculateLayer(IN, uv, bf, layer1factor, _UV3XPower.z);
            Result layeruv4 = CalculateLayer(IN, uv, bf, layer2factor, _UV3YPower.z);
            Result layeruv5 = CalculateLayer(IN, uv, bf, layer3factor, _UV4XPower.z);
            Result layeruv6 = CalculateLayer(IN, uv, bf, layer4factor, _UV4YPower.z);           
